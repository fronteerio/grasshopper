...
var updateApp = module.exports.updateApp = function(ctx, id, opts, callback) {
    ...
    // Validation
    var validator = new Validator();
    validator.check(null, {'code': 401, 'msg': 'Only administrators can create a new app'}).isAdmin(ctx);
 ...
 *
 * @param  {Context}        ctx                 Standard context containing the current user and the current app
 * @param  {Number}         appId               The id of the app on which the administrators should be updated
 ...
 * @param  {Object}         callback.err        An error object, if any
 */
var updateAppAdmins = function(ctx, appId, adminUpdates, callback) {
    callback = callback || function() {};
