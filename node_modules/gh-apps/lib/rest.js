 ...
 */
GrassHopper.globalAdminServer.get('/api/tenants/apps', function(req, res) {
    res.send(501);
});
 ...
 */
GrassHopper.globalAdminServer.get('/api/tenants/:tenantId/apps', function(req, res) {
    res.send(501);
});
 ...
 */
GrassHopper.globalAdminServer.get('/api/tenants/:tenantId/apps/:id', function(req, res) {
    res.send(501);
});
...
GrassHopper.globalAdminServer.get('/api/tenants/:tenantId/apps/:id/admins', getAppAdmins);
GrassHopper.tenantServer.get('/api/tenants/:tenantId/apps/:id/admins', getAppAdmins);
...
GrassHopper.globalAdminServer.post('/api/tenants/:tenantId/apps/:id', getAppAdmins);
GrassHopper.tenantServer.post('/api/tenants/:tenantId/apps/:id', getAppAdmins);
...
GrassHopper.globalAdminServer.post('/api/tenants/:tenantId/apps/:id/admins', updateAppAdministrators);
GrassHopper.tenantServer.post('/api/tenants/:tenantId/apps/:id/admins', updateAppAdministrators);
