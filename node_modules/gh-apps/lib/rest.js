 ...
 * @PathParam   {number}            tenantId        The id of the tenant to retrieve the apps for
 * @Return      {App[]}                             All available apps in the tenant
 */
GrassHopper.globalAdminServer.on('get', '/api/tenants/:tenantId/apps', function(req, res) {
    res.send(501);
});
