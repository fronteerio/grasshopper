...
GrassHopper.globalAdminRouter.on('post', '/api/apps/:id/admins', updateAppAdministrators);
GrassHopper.appRouter.on('post', '/api/apps/:id/admins', updateAppAdministrators);
