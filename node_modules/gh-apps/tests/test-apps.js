        ...
        it('verify get app', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestTenant(1, function(tenant, app) {
                    ...
                    AppsTestUtil.assertGetApp(globalAdminClient, app.id, app, function() {

                        // Verify that the created app can be retrieved by an anonymous global administrator
                        TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                            AppsTestUtil.assertGetApp(anonymousGlobalAdminClient, app.id, app, function() {
                                return callback();
                            });
                        });
                    });
        ...
        it('verify update app', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestTenant(1, function(tenant, app) {
                    ...
                    AppsTestUtil.assertUpdateApp(globalAdminClient, app, {'displayName': 'Ghent University'}, function(updatedApp) {
        ...
        it('verify update app authorization', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestTenant(1, function(tenant, app) {
                    ...
                    TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                        AppsTestUtil.assertUpdateAppFails(anonymousGlobalAdminClient, app.id, {'displayName': 'University of Manchester'}, 401, function() {
                            ...
                            TestsUtil.getAnonymousAppUserClient(app, function(anonymousUserClient) {
                                AppsTestUtil.assertUpdateAppFails(anonymousUserClient, app.id, {'displayName': 'University of Manchester'}, 401, function() {

                                    // Verify that a regular app user is not able to update an app
                                    TestsUtil.generateTestUsers(app, 1, false, function(appUser) {
                                        AppsTestUtil.assertUpdateAppFails(appUser.client, app.id, {'displayName': 'University of Manchester'}, 401, function() {
                                            ...
                                            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, true, function(differentAppAdmin) {
                                                AppsTestUtil.assertUpdateAppFails(differentAppAdmin.client, app.id, {'displayName': 'University of Manchester'}, 401, callback);
                                            });
                                        });
                                    });
                                });
        ...
        it('verify update app validation', function(callback) {
            ...
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                TestsUtil.generateTestTenant(1, function(tenant, app) {
                    ...
                    AppsTestUtil.assertUpdateAppFails(globalAdminClient, app.id, {}, 400, function() {

                        // Verify that all update fields need to be recognized when updating an app
                        AppsTestUtil.assertUpdateAppFails(globalAdminClient, app.id, {'displayName': 'UPMC', 'foo': 'bar'}, 400, function() {

                            // Verify that a valid name is required when updating the name of an app
                            AppsTestUtil.assertUpdateAppFails(globalAdminClient, app.id, {'displayName': ''}, 400, function() {
                                AppsTestUtil.assertUpdateAppFails(globalAdminClient, app.id, {'displayName': TestsUtil.generateString(257)}, 400, function() {

                                    // Verify that a valid enabled status is required when updating the enabled status of an app
                                    AppsTestUtil.assertUpdateAppFails(globalAdminClient, app.id, {'enabled': ''}, 400, function() {
                                        AppsTestUtil.assertUpdateAppFails(globalAdminClient, app.id, {'enabled': 'foo'}, 400, function() {

                                            // Verify that a valid host name is required when updating the host of an app
                                            AppsTestUtil.assertUpdateAppFails(globalAdminClient, app.id, {'host': ''}, 400, function() {

                                                // Verify that the host name of an app can not be updated to a host name that already exists
                                                AppsTestUtil.assertUpdateAppFails(globalAdminClient, app.id, {'host': global.tests.apps.oxford2014.host}, 400, callback);
                                            });
                                        });
                                    });
                                });
    ...
    describe('App administrators', function() {
            ...
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestTenant(1, function(tenant, app) {
                    ...
                    TestsUtil.generateTestUsers(app, 5, false, function() {
                        ...
                        AppsTestUtil.assertGetAppAdmins(globalAdminClient, app.id, null, null, 0, 0, function() {

                            // Make the first created user an administrator for the created app
                            var adminUpdate = {};
                            adminUpdate[createdUsers[0].profile.id] = true;
                            AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, app.id, adminUpdate, function() {

                                // Verify that the expected number of app administrators is returned
                                AppsTestUtil.assertGetAppAdmins(globalAdminClient, app.id, null, null, 1, 1, function() {
                                    ...
                                    AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, app.id, adminUpdate, function() {
                                        ...
                                        // Verify that the expected number of app administrators is returned
                                        AppsTestUtil.assertGetAppAdmins(globalAdminClient, app.id, null, null, 4, 4, function() {
                                            ...
                                            AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, app.id, adminUpdate, function() {
                                                ...
                                                // Verify that the expected number of app administrators is returned
                                                AppsTestUtil.assertGetAppAdmins(globalAdminClient, app.id, null, null, 3, 3, function() {
                                                    ...
                                                    AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, app.id, adminUpdate, function() {
                                                        ...
                                                        AppsTestUtil.assertGetAppAdmins(globalAdminClient, app.id, null, null, 1, 1, function() {
                                                            ...
                                                            AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, app.id, adminUpdate, function() {
                                                                ...
                                                                // Verify that the expected number of app administrators is returned
                                                                AppsTestUtil.assertGetAppAdmins(globalAdminClient, app.id, null, null, 2, 2, function() {
                                                                    ...
                                                                    AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, app.id, adminUpdate, function() {
                                                                        ...
                                                                        // Verify that the expected number of app administrators is returned
                                                                        AppsTestUtil.assertGetAppAdmins(createdUsers[0].client, app.id, null, null, 1, 1, function() {
                                                                            return callback();
                                                                        });
                                                                    });
                                                                });
        ...
        it('verify get app administrators authorization', function(callback) {
            ...
            TestsUtil.generateTestTenant(1, function(tenant, app) {
                ...
                TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                    AppsTestUtil.assertGetAppAdminsFails(anonymousGlobalAdminClient, app.id, null, null, 401, function() {

                        // Verify that an anonymous app user is not able to get the administrators of an app
                        TestsUtil.getAnonymousAppUserClient(app, function(anonymousUserClient) {
                            AppsTestUtil.assertGetAppAdminsFails(anonymousUserClient, app.id, null, null, 401, function() {

                                // Verify that a regular app user is not able to get the administrators of an app
                                TestsUtil.generateTestUsers(app, 1, false, function(appUser) {
                                    AppsTestUtil.assertGetAppAdminsFails(appUser.client, app.id, null, null, 401, function() {

                                        // Verify that a user from a different app is not able to get the administrators of an app
                                        TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, true, function(differentAppAdmin) {
                                            AppsTestUtil.assertGetAppAdminsFails(differentAppAdmin.client, app.id, null, null, 401, callback);
                                        });
                                    });
                                });
                            });
        ...
        it('verify get app administrators validation', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                AppsTestUtil.assertGetAppAdminsFails(globalAdminClient, 'foo', null, null, 400, function() {

                    // Verify that an existing app id is required when getting the administrators of an app
                    AppsTestUtil.assertGetAppAdminsFails(globalAdminClient, 4242, null, null, 404, callback);
                });
            });
        });
            ...
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestTenant(1, function(tenant, app) {
                    ...
                    TestsUtil.generateTestUsers(app, 5, true, function() {
                        ...
                        AppsTestUtil.assertGetAppAdmins(globalAdminClient, app.id, null, 0, 5, 5, function() {
                            // Verify that the second page of app administrators returns no results
                            AppsTestUtil.assertGetAppAdmins(globalAdminClient, app.id, null, 10, 0, 5, function() {
            ...
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestTenant(1, function(tenant, app) {
                    ...
                    TestsUtil.generateTestUsers(app, 1, false, function(createdUser) {
                        ...
                        TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                            AppsTestUtil.assertUpdateAppAdminsFails(anonymousGlobalAdminClient, app.id, adminUpdate, 401, function() {

                                // Verify that an anonymous app user is not able to update the administrators of an app
                                TestsUtil.getAnonymousAppUserClient(app, function(anonymousUserClient) {
                                    AppsTestUtil.assertUpdateAppAdminsFails(anonymousUserClient, app.id, adminUpdate, 401, function() {

                                        // Verify that a regular app user is not able to update its own administrator status
                                        AppsTestUtil.assertUpdateAppAdminsFails(createdUser.client, app.id, adminUpdate, 401, function() {

                                            // Verify that a regular app user is not able to update the administrators of an app
                                            TestsUtil.generateTestUsers(app, 1, false, function(appUser) {
                                                AppsTestUtil.assertUpdateAppAdminsFails(appUser.client, app.id, adminUpdate, 401, function() {

                                                    // Verify that a user from a different app is not able to get the administrators of an app
                                                    TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, true, function(differentAppAdmin) {
                                                        AppsTestUtil.assertUpdateAppAdminsFails(differentAppAdmin.client, app.id, adminUpdate, 401, callback);
                                                    });
                                                });
                                            });
                                        });
        ...
        it('verify update app administrators validation', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestTenant(1, function(tenant, app) {
                    ...
                    AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, app.id, {}, 400, function() {
                        ...
                        TestsUtil.generateTestUsers(app, 1, false, function(createdUser) {
                            ...
                            AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, app.id, adminUpdate, 400, function() {
                                ...
                                AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, app.id, adminUpdate, 400, function() {
                                    ...
                                    TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(createdCamUser) {
                                        ...
                                        AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, app.id, adminUpdate, 400, function() {
                                            ...
                                            AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, app.id, adminUpdate, 400, callback);
                                        });
                                    });
                                });
                            });
