    ...
    describe('App administrators', function() {
        ...
        it('verify app administrators', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestApp(global.tests.tenants.cam.id, function(createdApp) {
                    ...
                    TestsUtil.generateTestUsers(createdApp, 5, false, function() {
                        var createdUsers = arguments;
                        // Verify that there are no administrators for the app
                        AppsTestUtil.assertGetAppAdmins(globalAdminClient, createdApp.id, null, null, 0, 0, function() {

                            // Make the first created user an administrator for the created app
                            var adminUpdate = {};
                            adminUpdate[createdUsers[0].profile.id] = true;
                            AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, createdApp.id, adminUpdate, function() {

                                // Verify that the expected number of app administrators is returned
                                AppsTestUtil.assertGetAppAdmins(globalAdminClient, createdApp.id, null, null, 1, 1, function() {
                                    ...
                                    AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, createdApp.id, adminUpdate, function() {
                                        ...
                                        // Verify that the expected number of app administrators is returned
                                        AppsTestUtil.assertGetAppAdmins(globalAdminClient, createdApp.id, null, null, 4, 4, function() {
                                            ...
                                            AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, createdApp.id, adminUpdate, function() {
                                                ...
                                                // Verify that the expected number of app administrators is returned
                                                AppsTestUtil.assertGetAppAdmins(globalAdminClient, createdApp.id, null, null, 3, 3, function() {
                                                    ...
                                                    AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, createdApp.id, adminUpdate, function() {
                                                        ...
                                                        AppsTestUtil.assertGetAppAdmins(globalAdminClient, createdApp.id, null, null, 1, 1, function() {
                                                            ...
                                                            AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, createdApp.id, adminUpdate, function() {
                                                                ...
                                                                // Verify that the expected number of app administrators is returned
                                                                AppsTestUtil.assertGetAppAdmins(globalAdminClient, createdApp.id, null, null, 2, 2, function() {
                                                                    ...
                                                                    AppsTestUtil.assertUpdateAppAdmins(globalAdminClient, createdApp.id, adminUpdate, function() {
                                                                        ...
                                                                        // Verify that the expected number of app administrators is returned
                                                                        AppsTestUtil.assertGetAppAdmins(createdUsers[0].client, createdApp.id, null, null, 1, 1, function() {
                                                                            return callback();
                                                                        });
                                                                    });
                                                                });
        ...
        it('verify get app administrators authorization', function(callback) {
            ...
            TestsUtil.generateTestApp(global.tests.tenants.cam.id, function(createdApp) {
                ...
                TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                    AppsTestUtil.assertGetAppAdminsFails(anonymousGlobalAdminClient, createdApp.id, null, null, 401, function() {

                        // Verify that an anonymous app user is not able to get the administrators of an app
                        TestsUtil.getAnonymousAppUserClient(createdApp, function(anonymousUserClient) {
                            AppsTestUtil.assertGetAppAdminsFails(anonymousUserClient, createdApp.id, null, null, 401, function() {

                                // Verify that a regular app user is not able to get the administrators of an app
                                TestsUtil.generateTestUsers(createdApp, 1, false, function(appUser) {
                                    AppsTestUtil.assertGetAppAdminsFails(appUser.client, createdApp.id, null, null, 401, function() {

                                        // Verify that a user from a different app is not able to get the administrators of an app
                                        TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, true, function(differentAppAdmin) {
                                            AppsTestUtil.assertGetAppAdminsFails(differentAppAdmin.client, createdApp.id, null, null, 401, callback);
                                        });
                                    });
                                });
                            });
        ...
        it('verify get app administrators validation', function(callback) {
            // Verify that an id is required when getting the administrators of an app
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                AppsTestUtil.assertGetAppAdminsFails(globalAdminClient, null, null, null, 400, function() {
        ...
        it('verify update app administrators authorization', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestApp(global.tests.tenants.cam.id, function(createdApp) {
                    ...
                    TestsUtil.generateTestUsers(createdApp, 1, false, function(createdUser) {
                        var adminUpdate = {};
                        ...
                        TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                            AppsTestUtil.assertUpdateAppAdminsFails(anonymousGlobalAdminClient, createdApp.id, adminUpdate, 401, function() {

                                // Verify that an anonymous app user is not able to update the administrators of an app
                                TestsUtil.getAnonymousAppUserClient(createdApp, function(anonymousUserClient) {
                                    AppsTestUtil.assertUpdateAppAdminsFails(anonymousUserClient, createdApp.id, adminUpdate, 401, function() {

                                        // Verify that a regular app user is not able to update its own administrator status
                                        AppsTestUtil.assertUpdateAppAdminsFails(createdUser.client, createdApp.id, adminUpdate, 401, function() {

                                            // Verify that a regular app user is not able to update the administrators of an app
                                            TestsUtil.generateTestUsers(createdApp, 1, false, function(appUser) {
                                                AppsTestUtil.assertUpdateAppAdminsFails(appUser.client, createdApp.id, adminUpdate, 401, function() {

                                                    // Verify that a user from a different app is not able to get the administrators of an app
                                                    TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, true, function(differentAppAdmin) {
                                                        AppsTestUtil.assertUpdateAppAdminsFails(differentAppAdmin.client, createdApp.id, adminUpdate, 401, callback);
                                                    });
                                                });
                                            });
                                        });
        ...
        it('verify update app administrators validation', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TestsUtil.generateTestApp(global.tests.tenants.cam.id, function(createdApp) {
                    ...
                    AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, createdApp.id, {}, 400, function() {
                        ...
                        TestsUtil.generateTestUsers(createdApp, 1, false, function(createdUser) {
                            ...
                            AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, createdApp.id, adminUpdate, 400, function() {
                                ...
                                AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, createdApp.id, adminUpdate, 400, function() {
                                    ...
                                    TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(createdCamUser) {
                                        ...
                                        AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, createdApp.id, adminUpdate, 400, function() {
                                            ...
                                            AppsTestUtil.assertUpdateAppAdminsFails(globalAdminClient, createdApp.id, adminUpdate, 400, callback);
                                        });
                                    });
                                });
                            });
