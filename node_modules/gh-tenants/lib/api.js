...
var getTenants = module.exports.getTenants = function(ctx, callback) {
    ...
    if (!ctx.user || !ctx.user.isGlobalAdmin()) {
        return callback({'code': 401, 'msg': 'Only global administrators can list the available tenants'});
    }
...
var getTenant = module.exports.getTenant = function(id, callback) {
    ...
    if (!ctx.user || !ctx.user.isGlobalAdmin()) {
        return callback({'code': 401, 'msg': 'Only global administrators can get a tenant'});
    }
...
var createTenant = module.exports.createTenant = function(displayName, callback) {
    ...
    if (!ctx.user || !ctx.user.isGlobalAdmin()) {
        return callback({'code': 401, 'msg': 'Only global administrators can create a new tenant'});
    }
...
var updateTenant = module.exports.updateTenant = function(id, displayName, callback) {
    ...
    if (!ctx.user || !ctx.user.isGlobalAdmin()) {
        return callback({'code': 401, 'msg': 'Only global administrators can update a tenant'});
    }
