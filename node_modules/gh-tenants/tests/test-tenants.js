...
describe('Tenants', function() {
    ...
    describe('Get all tenants', function() {
        ...
        it('verify get all tenants', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TenantsTestUtil.assertGetTenants(globalAdminClient, null, function(tenants) {
                    ...
                    var cambridgeTenant = _.find(tenants, function(tenant) { return tenant.displayName === tests.tenants.cam.displayName });
                    TenantsTestUtil.assertTenant(cambridgeTenant, tests.tenants.cam);

                    // Verify that the default Oxford tenant is present
                    var oxfordTenant = _.find(tenants, function(tenant) { return tenant.displayName === tests.tenants.oxford.displayName });
                    TenantsTestUtil.assertTenant(oxfordTenant, tests.tenants.oxford);

                    // Verify that the Georgia Tech tenant is not present
                    var gtTenant = _.find(tenants, function(tenant) { return tenant.displayName === 'Georgia Tech' });
                    assert.ok(!gtTenant);
        ...
        /**
         * Test that verifies validation for retrieving all tenants
         */
        it('verify get all tenants validation', function(callback) {
                    ...
                    TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                        TenantsTestUtil.assertGetTenantFails(globalAdminClient, null, 400, function() {
                            ...
                            TenantsTestUtil.assertGetTenantFails(globalAdminClient, 'foo', 400, function() {
                                ...
                                TenantsTestUtil.assertGetTenantFails(globalAdminClient, 42, 404, callback);
                            });
                        });
                    });
                });
