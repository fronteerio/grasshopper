...
var TenantsTestsUtil = require('./util');
...
describe('Tenants', function() {
    ...
    describe('Get all tenants', function() {
        ...
        it('verify get all tenants', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TenantsTestsUtil.assertGetTenants(globalAdminClient, null, function(tenants) {
                    ...
                    TenantsTestsUtil.assertTenant(cambridgeTenant, tests.tenants.cam);
                    ...
                    TenantsTestsUtil.assertTenant(oxfordTenant, tests.tenants.oxford);
                    ...
                    TenantsTestsUtil.assertCreateTenant(globalAdminClient, 'Georgia Tech', function(createdGtTenant) {

                        // Retrieve all tenants
                        TenantsTestsUtil.assertGetTenants(globalAdminClient, total + 1, function(tenants) {

                            // Verify that the Georgia tenant is present
                            var gtTenant = _.where(tenants, {'displayName': 'Georgia Tech'})[0];
                            TenantsTestsUtil.assertTenant(gtTenant, createdGtTenant);
        ...
        it('verify get all tenants authorization', function(callback) {
            ...
            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                TenantsTestsUtil.assertGetTenantsFails(anonymousGlobalAdminClient, 401, callback);
            });
        });
    });
    ...
    describe('Get tenant', function() {
        ...
        it('verify get tenant', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                // Create a new tenant
                TenantsTestsUtil.assertCreateTenant(globalAdminClient, 'Marist College', function(createdMaristTenant) {
                    // Verify that the created tenant can be retrieved
                    TenantsTestsUtil.assertGetTenant(globalAdminClient, createdMaristTenant.id, createdMaristTenant, function(tenant) {
                        return callback();
                    });
                });
            });
        ...
        it('verify get tenant authorization', function(callback) {
            ...
            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                TenantsTestsUtil.assertGetTenantFails(anonymousGlobalAdminClient, tests.tenants.cam.id, 401, callback);
            });
        });
        ...
        it('verify get tenant validation', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TenantsTestsUtil.assertGetTenantFails(globalAdminClient, 'foo', 400, function() {
                    // Verify that an existing tenant id is required when getting a tenant
                    TenantsTestsUtil.assertGetTenantFails(globalAdminClient, 4242, 404, callback);
                });
            });
        });
    });
    ...
    describe('Create tenant', function() {
        ...
        it('verify create tenant', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TenantsTestsUtil.assertCreateTenant(globalAdminClient, 'University of Amsterdam', function(createdAmsterdamTenant) {
                    // Verify that a tenant with the same name can be created
                    TenantsTestsUtil.assertCreateTenant(globalAdminClient, 'University of Amsterdam', function(createdAmsterdamTenant2) {
        ...
        it('verify create tenant authorization', function(callback) {
            ...
            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                TenantsTestsUtil.assertCreateTenantFails(anonymousGlobalAdminClient, 'Harvard University', 401, callback);
            });
        });
        ...
        it('verify create tenant validation', function(callback) {
            ...
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                TenantsTestsUtil.assertCreateTenantFails(globalAdminClient, null, 400, function() {
                    // Verify that a valid name is required when creating a new tenant
                    TenantsTestsUtil.assertCreateTenantFails(globalAdminClient, '', 400, function() {
                        TenantsTestsUtil.assertCreateTenantFails(globalAdminClient, TestsUtil.generateString(257), 400, callback);
                    });
                });
            });
        });
    ...
    describe('Update tenant', function() {
        ...
        it('verify update tenant', function(callback) {
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                TenantsTestsUtil.assertCreateTenant(globalAdminClient, 'UC Berkeley', function(createdUCBTenant) {
                    TenantsTestsUtil.assertUpdateTenant(globalAdminClient, createdUCBTenant, 'University of California Berkeley', function(updatedUCBTenant) {
                        return callback();
                    });
                });
            });
        ...
        it('verify update tenant authorization', function(callback) {
            ...
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                TenantsTestsUtil.assertCreateTenant(globalAdminClient, 'Princeton University', function(createdPrincetonTenant) {
                    TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                        TenantsTestsUtil.assertUpdateTenantFails(anonymousGlobalAdminClient, createdPrincetonTenant.id, 'MIT', 401, callback);
                    });
                });
            });
        });
        ...
        it('verify update tenant validation', function(callback) {
            ...
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                TenantsTestsUtil.assertCreateTenant(globalAdminClient, 'Princeton University', function(createdPrincetonTenant) {
                    TenantsTestsUtil.assertUpdateTenantFails(globalAdminClient, createdPrincetonTenant.id, null, 400, function() {
                        // Verify that a valid updated name is required when updating a tenant
                        TenantsTestsUtil.assertUpdateTenantFails(globalAdminClient, createdPrincetonTenant.id, '', 400, function() {
                            TenantsTestsUtil.assertUpdateTenantFails(globalAdminClient, createdPrincetonTenant.id, TestsUtil.generateString(257), 400, function() {
                                // Verify that an existing tenant id is required when updating a tenant
                                TenantsTestsUtil.assertUpdateTenantFails(globalAdminClient, 42, 'MIT', 404, callback);
                            });
                        });
                    });
                });
