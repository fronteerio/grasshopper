 ...
 */
GrassHopper.appServer.on('get', '/api/groups/:id/members', function(req, res) {
    res.send(501);
});
 ...
 * @Return      {void}
 */
GrassHopper.appServer.on('post', '/api/groups/:id/members', function(req, res) {
    res.send(501);
});
 ...
 * @Return      {void}
 */
GrassHopper.appServer.on('post', '/api/groups/:id/lock', function(req, res) {
    res.send(501);
});
 ...
 * @Return      {void}
 */
GrassHopper.appServer.on('delete', '/api/groups/:id/lock', function(req, res) {
    res.send(501);
});
