 ...
 * @param  {User[]}             [expectedMemberships]   The expected memberships
 * @param  {Function}           callback                Standard callback function
 * @param  {OrgUnit}            callback.memberships    The members of the group
 * @throws {AssertionError}                             Error thrown when an assertion failed
 */
var assertGetUserMemberships = module.exports.assertGetUserMemberships = function(client, id, limit, offset, expectedMemberships, callback) {
    client.group.getUserMemberships(id, limit, offset, function(err, memberships) {
        ...
        if (expectedMemberships) {
            assert.strictEqual(memberships.results.length, expectedMemberships.length);
            _.each(memberships.results, function(membership) {
                assert.ok(_.contains(expectedMemberships, membership.id));
            });
        }
