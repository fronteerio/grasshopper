    ...
    describe('Getting user memberships', function() {
            ...
            OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                ...
                TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(user) {
                    ...
                    GroupsTestUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, orgUnit.GroupId, update, function() {
                        ...
                        GroupsTestUtil.assertGetUserMembershipsEquals(global.tests.admins.cam2013.client, user.profile.id, null, null, [orgUnit.GroupId], function(memberships) {
                            return callback();
                        });
                    });
                });
                                ...
                                TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                                    GroupsTestUtil.assertGetGroupMembersFails(anonymousGlobalAdminClient, simon.profile.id, null, null, 401, function() {
                                        ...
                                        GroupsTestUtil.assertGetUserMembershipsFails(nico.client, simon.profile.id, null, null, 401, function() {
                                            ...
                                            GroupsTestUtil.assertGetUserMembershipsEquals(simon.client, simon.profile.id, null, null, [], function() {
                                                ...
                                                GroupsTestUtil.assertGetUserMembershipsFails(global.tests.admins.cam2014.client, simon.profile.id, null, null, 401, function() {
                                                    ...
                                                    GroupsTestUtil.assertGetUserMembershipsEquals(global.tests.admins.cam2013.client, simon.profile.id, null, null, [], function() {

                                                        // Global administrators can get all user's memberships
                                                        TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                                                            GroupsTestUtil.assertGetUserMembershipsEquals(globalAdminClient, simon.profile.id, null, null, [], function() {
                                                                GroupsTestUtil.assertGetUserMembershipsEquals(globalAdminClient, nico.profile.id, null, null, [], function() {
                                                                    return callback();
                                                                });
                                                            });
                                                        });
        ...
        var _addUserToGroups = function(client, userId, groupIds, callback) {
            ...
            _.each(groupIds, function(groupId) {
                var update = {};
                update[userId] = true;
                GroupsTestUtil.assertUpdateGroupMembers(client, groupId, update, _done);
            });
        };
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(user) {
                ...
                OrgUnitTestUtil.generateOrgUnits(global.tests.admins.cam2013.client, 30, function() {
                    ...
                    _addUserToGroups(global.tests.admins.cam2013.client, user.profile.id, groupIds, function() {
                        ...
                        GroupsTestUtil.assertGetUserMembershipsEquals(global.tests.admins.cam2013.client, user.profile.id, null, null, null, function(memberships) {
                            assert.strictEqual(memberships.results.length, 25);

                            // Verify proper paging
                            // Get the first set of memberships
                            GroupsTestUtil.assertGetUserMembershipsEquals(global.tests.admins.cam2013.client, user.profile.id, 15, null, null, function(firstPage) {
                                assert.strictEqual(firstPage.results.length, 15);

                                // Verify the next set of memberships
                                GroupsTestUtil.assertGetUserMembershipsEquals(global.tests.admins.cam2013.client, user.profile.id, 15, 15, null, function(secondPage) {
