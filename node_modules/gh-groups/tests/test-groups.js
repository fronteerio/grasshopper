...
describe('Groups', function() {
        ...
        it('verify a group has no members when created by a global admin', function(callback) {
            ...
            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                ...
                OrgUnitTestUtil.assertCreateOrgUnit(globalAdminClient, 'Test org unit', 'course', opts, function(orgUnit) {
                    ...
                    GroupsTestUtil.assertGetGroupMembers(globalAdminClient, orgUnit.GroupId, null, null, [], function(members) {
                        ...
                        TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                            GroupsTestUtil.assertGetGroupMembersFails(anonymousClient, orgUnit.GroupId, null, null, 401, function() {
                                TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                                    GroupsTestUtil.assertGetGroupMembersFails(anonymousGlobalAdminClient, orgUnit.GroupId, null, null, 401, function() {
                                        ...
                                        GroupsTestUtil.assertGetGroupMembersFails(simon.client, orgUnit.GroupId, null, null, 401, function() {
                                            ...
                                            GroupsTestUtil.assertGetGroupMembersFails(nico.client, orgUnit.GroupId, null, null, 401, function() {
                                                ...
                                                GroupsTestUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, orgUnit.GroupId, update, function() {
                                                    ...
                                                    GroupsTestUtil.assertGetGroupMembers(simon.client, orgUnit.GroupId, null, null, null, function(members) {
                                                        ...
                                                        GroupsTestUtil.assertGetGroupMembersFails(global.tests.admins.cam2014.client, orgUnit.GroupId, null, null, 401, function(members) {
                                                            ...
                                                            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                                                                GroupsTestUtil.assertGetGroupMembers(globalAdminClient, orgUnit.GroupId, null, null, null, function(members) {
                                                                    return callback();
                                                                });
                                                            });
                                                        });
                ...
                OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                    ...
                    TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                        GroupsTestUtil.assertUpdateGroupMembersFails(anonymousClient, orgUnit.GroupId, update, 401, function() {
                            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                                GroupsTestUtil.assertUpdateGroupMembersFails(anonymousGlobalAdminClient, orgUnit.GroupId, update, 401, function() {
                                            ...
                                            GroupsTestUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, orgUnit.GroupId, update, function() {
                                                ...
                                                GroupsTestUtil.assertUpdateGroupMembers(simon.client, orgUnit.GroupId, update, function() {
                                                    ...
                                                    TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                                                        ...
                                                        GroupsTestUtil.assertUpdateGroupMembers(globalAdminClient, orgUnit.GroupId, update, function() {
                                                            return callback();
                                                        });
                                                    });
                                                });
        ...
        it('verify users cannot be added to a group from another application', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.oxford2014, 1, false, function(nico) {
                ...
                OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                    ...
                    var update = {};
                    update[nico.profile.id] = true;
                    GroupsTestUtil.assertUpdateGroupMembersFails(global.tests.admins.cam2013.client, orgUnit.GroupId, update, 400, callback);
                });
            });
        });
    });
    ...
    describe('Group locking', function() {
        ...
        it('verify a group can be locked', function(callback) {
            ...
            OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                ...
                // Lock it
                GroupsTestUtil.assertLock(global.tests.admins.cam2013.client, orgUnit.GroupId, function() {
        ...
        it('verify validation when locking a group', function(callback) {
            // Invalid group id
            GroupsTestUtil.assertLockFails(global.tests.admins.cam2013.client, 'Not a number', 400, function() {

                // Unknown group id
                GroupsTestUtil.assertLockFails(global.tests.admins.cam2013.client, 23423423, 404, function() {
                    GroupsTestUtil.assertLockFails(global.tests.admins.cam2013.client, -1, 404, function() {
                        return callback();
                    });
                });
            });
        ...
        it('verify authorization when locking a group', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 2, false, function(simon, nico) {
                ...
                OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                    ...
                    TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                        GroupsTestUtil.assertLockFails(anonymousClient, orgUnit.GroupId, 401, function() {

                            // Non-members cannot lock a group
                            GroupsTestUtil.assertLockFails(simon.client, orgUnit.GroupId, 401, function() {

                                // Administrators from other applications cannot lock a group
                                GroupsTestUtil.assertLockFails(global.tests.admins.cam2014.client, orgUnit.GroupId, 401, function() {
                                    ...
                                    GroupsTestUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, orgUnit.GroupId, update, function() {
                                        ...
                                        GroupsTestUtil.assertLock(simon.client, orgUnit.GroupId, function() {

                                            // Nico can't lock the group as it's already locked by Simon
                                            GroupsTestUtil.assertLockFails(nico.client, orgUnit.GroupId, 401, function() {
                                                return callback();
                                            });
                                        });
                                    });
    ...
    describe('Group unlocking', function() {
            ...
            OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                ...
                GroupsTestUtil.assertLock(global.tests.admins.cam2013.client, orgUnit.GroupId, function() {
                    ...
                    OrgUnitTestUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, null, true, null, null, function(orgUnits) {
                        ...
                        // Release the lock
                        GroupsTestUtil.assertReleaseLock(global.tests.admins.cam2013.client, orgUnit.GroupId, function() {
        ...
        it('verify validation when releasing the lock on a group', function(callback) {
            // Invalid group id
            GroupsTestUtil.assertReleaseLockFails(global.tests.admins.cam2013.client, 'Not a number', 400, function() {

                // Unknown group id
                GroupsTestUtil.assertReleaseLockFails(global.tests.admins.cam2013.client, 12312321, 404, function() {
                    GroupsTestUtil.assertReleaseLockFails(global.tests.admins.cam2013.client, -1, 404, function() {
                        return callback();
                    });
                });
            });
                ...
                OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                    ...
                    GroupsTestUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, orgUnit.GroupId, update, function() {
                        ...
                        GroupsTestUtil.assertLock(simon.client, orgUnit.GroupId, function() {
                            ...
                            TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                                GroupsTestUtil.assertReleaseLockFails(anonymousClient, orgUnit.GroupId, 401, function() {

                                    // Regular users cannot release locks on groups that they're not a member of
                                    GroupsTestUtil.assertReleaseLockFails(sam.client, orgUnit.GroupId, 401, function() {

                                        // Administrators from other applications cannot release locks
                                        GroupsTestUtil.assertReleaseLockFails(global.tests.admins.cam2014.client, orgUnit.GroupId, 401, function() {

                                            // Nico can't release the lock on the group as it's locked by Simon
                                            GroupsTestUtil.assertReleaseLockFails(nico.client, orgUnit.GroupId, 401, function() {

                                                // Simon can release it
                                                GroupsTestUtil.assertReleaseLock(simon.client, orgUnit.GroupId, function() {
    ...
    describe('Getting user memberships', function() {
            ...
            OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                ...
                TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(user) {
                    ...
                    GroupsTestUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, orgUnit.GroupId, update, function() {
                        ...
                        GroupsTestUtil.assertGetUserMemberships(global.tests.admins.cam2013.client, user.profile.id, null, null, [orgUnit.GroupId], function(memberships) {
                            return callback();
                        });
                    });
                });
        ...
        it('verify getting user memberships validation', function(callback) {
            // Invalid user id
            GroupsTestUtil.assertGetUserMembershipsFails(global.tests.admins.cam2013.client, 'not a number', null, null, 400, function() {

                // Unknown user
                GroupsTestUtil.assertGetUserMembershipsFails(global.tests.admins.cam2013.client, -1, null, null, 404, function() {
                    GroupsTestUtil.assertGetUserMembershipsFails(global.tests.admins.cam2013.client, 23423234, null, null, 404, function() {
                        return callback();
                    });
                });
            });
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                TestsUtil.generateTestUsers(global.tests.apps.cam2014, 1, false, function(nico) {
                    ...
                    OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                        ...
                        TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                            GroupsTestUtil.assertGetUserMembershipsFails(anonymousClient, simon.profile.id, null, null, 401, function() {
                                TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                                    GroupsTestUtil.assertGetGroupMembersFails(anonymousGlobalAdminClient, simon.profile.id, null, null, 401, function() {

                                        // Regular users can not get another user's memberships
                                        GroupsTestUtil.assertGetUserMembershipsFails(nico.client, simon.profile.id, null, null, 401, function() {

                                            // Regular users can get their own memberships
                                            GroupsTestUtil.assertGetUserMemberships(simon.client, simon.profile.id, null, null, [], function() {

                                                // Application administrators can not get users from another application their memberships
                                                GroupsTestUtil.assertGetUserMembershipsFails(global.tests.admins.cam2014.client, simon.profile.id, null, null, 401, function() {

                                                    // Application administrators can get users their memberships from their own application
                                                    GroupsTestUtil.assertGetUserMemberships(global.tests.admins.cam2013.client, simon.profile.id, null, null, [], function() {

                                                        // Global administrators can get all users their memberships
                                                        TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                                                            GroupsTestUtil.assertGetUserMemberships(globalAdminClient, simon.profile.id, null, null, [], function() {
                                                                GroupsTestUtil.assertGetUserMemberships(globalAdminClient, nico.profile.id, null, null, [], function() {
                                                                    return callback();
                                                                });
                                                            });
                                                        });
         ...
         *
         * @param {Client}      client      The client who will be adding the user to the groups
         ...
         */
        var addUserToGroups = function(client, userId, groupIds, callback) {
            var done = _.after(groupIds.length, callback);

            _.each(groupIds, function(groupId) {
                var update = {};
                update[userId] = true;
                GroupsTestUtil.assertUpdateGroupMembers(client, groupId, update, done);
            });
        };
        ...
        it('verify getting user memberships paging', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(user) {
                ...
                OrgUnitTestUtil.generateOrgUnits(global.tests.admins.cam2013.client, 30, function() {
                    ...
                    addUserToGroups(global.tests.admins.cam2013.client, user.profile.id, groupIds, function() {

                        // Verify that specifying no limit defaults to 25
                        GroupsTestUtil.assertGetUserMemberships(global.tests.admins.cam2013.client, user.profile.id, null, null, null, function(memberships) {
                            assert.strictEqual(memberships.results.length, 25);

                            // Verify proper paging
                            // Get the first set of memberships
                            GroupsTestUtil.assertGetUserMemberships(global.tests.admins.cam2013.client, user.profile.id, 15, null, null, function(firstPage) {
                                assert.strictEqual(firstPage.results.length, 15);

                                // Verify the next set of memberships
                                GroupsTestUtil.assertGetUserMemberships(global.tests.admins.cam2013.client, user.profile.id, 15, 15, null, function(secondPage) {
