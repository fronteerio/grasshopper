 ...
 * @param  {String}         rangeStart              The datetime when can start
 * @param  {String}         rangeEnd                The datetime when events should end
 * @param  {Function}       callback                Standard callback function
 * @param  {Event[]}        callback.events         The created events. This array will be sorted on it's created timestamp
 * @throws {AssertionError}                         Error thrown when an assertion failed
 */
var generateTestEvents = module.exports.generateTestEvents = function(client, total, rangeStart, rangeEnd, callback, _events) {
    ...
    // Create the event
    assertCreateEvent(client, 'Test event', startFormatted, endFormatted, null, function(event) {
        _events.push(event);
