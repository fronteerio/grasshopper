                ...
                EventsTestUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(event) {
                    ...
                    EventsTestUtil.assertUpdateEventOrganisers(simon.client, event.id, update, function() {
                        ...
                        EventsTestUtil.assertGetEvent(simon.client, event.id, null, function(event) {
                            ...
                            UsersTestsUtil.assertUser(organisersById[nico.profile.id], {'expectedUser': nico.profile, 'canViewAllFields': false});

                            // Simon his own personal info should be displayed
                            UsersTestsUtil.assertUser(organisersById[simon.profile.id], {'expectedUser': simon.profile, 'canViewAllFields': true});
                            return callback();
                        });
                    });
                });
        ...
        it('verify validation when adding and/or removing organisers from events', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                EventsTestUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(event) {
                    ...
                    // Invalid event id
                    EventsTestUtil.assertUpdateEventOrganisersFails(simon.client, 'not a number', {'Jack': true}, 400, function() {
                        // Unknown event id
                        EventsTestUtil.assertUpdateEventOrganisersFails(simon.client, -1, {'Jack': true}, 404, function() {

                            // No organiser
                            EventsTestUtil.assertUpdateEventOrganisersFails(simon.client, event.id, {}, 400, function() {

                                // Specified unknown user id
                                EventsTestUtil.assertUpdateEventOrganisersFails(simon.client, event.id, {'-1': true}, 400, function() {

                                    // Not a boolean value
                                    EventsTestUtil.assertUpdateEventOrganisersFails(simon.client, event.id, {'Dr Jack Daniels': 'Not a boolean'}, 400, function() {
                                        return callback();
                                    });
                                });
                            });
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 4, false, function(simon, nico, sam, bert) {
                ...
                EventsTestUtil.assertCreateEvent(simon.client, 'Test event', start, end, opts, function(event) {
                    ...
                    TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                        EventsTestUtil.assertUpdateEventOrganisersFails(anonymousClient, event.id, update, 401, function() {
                            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                                EventsTestUtil.assertUpdateEventOrganisersFails(anonymousGlobalAdminClient, event.id, update, 401, function() {

                                    // Authenticated users unrelated to the event cannot update the organisers of an event
                                    EventsTestUtil.assertUpdateEventOrganisersFails(bert.client, event.id, update, 401, function() {

                                        // App admins from another application cannot update the organisers of an event
                                        EventsTestUtil.assertUpdateEventOrganisersFails(global.tests.admins.oxford2014.client, event.id, update, 401, function() {

                                            // Organisers can update the organisers of the event
                                            EventsTestUtil.assertUpdateEventOrganisers(nico.client, event.id, update, function() {
                                                ...
                                                GroupsTestsUtil.assertUpdateGroupMembers(simon.client, event.GroupId, membersUpdate, function() {
                                                    EventsTestUtil.assertUpdateEventOrganisers(sam.client, event.id, update, function() {

                                                        // Application admins can update the organisers of an event
                                                        EventsTestUtil.assertUpdateEventOrganisers(global.tests.admins.cam2013.client, event.id, update, function() {

                                                            // Global admins can update the organisers of the event
                                                            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                                                                EventsTestUtil.assertUpdateEventOrganisers(globalAdminClient, event.id, update, function() {
                                                                    return callback();
                                                                });
                                                            });
                                                        });
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                TestsUtil.generateTestUsers(global.tests.apps.oxford2014, 2, false, function(nico) {
                    ...
                    EventsTestUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(event) {
                        ...
                        var update = {};
                        update[nico.profile.id] = true;
                        EventsTestUtil.assertUpdateEventOrganisersFails(global.tests.admins.cam2013.client, event.id, update, 400, callback);
                    });
                });
            });
        });
