    ...
    describe('Create event', function() {
        ...
        it('verify create event', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 3, false, function(simon, nico, sam) {
                ...
                EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(createdEvent) {
                    ...
                    EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, opts, function(createdEvent) {
        ...
        it('verify organisers are validated', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                TestsUtil.generateTestUsers(global.tests.apps.cam2014, 1, false, function(nicolaas) {
                    ...
                    EventsTestsUtil.assertCreateEventFails(simon.client, 'Test event', start, end, opts, 400, function() {
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(createdEvent) {
                    ...
                    TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                        ...
                        EventsTestsUtil.assertCreateEvent(globalAdminClient, 'Test event', start, end, opts, function(createdEvent) {
        ...
        it('verify an existing group can be used when creating events', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2014.client, 'Test org unit', 'course', null, function(otherAppOrgUnit) {
                ...
                EventsTestsUtil.assertCreateEventFails(global.tests.admins.cam2013.client, 'Test event', start, end, opts, 401, function() {
                    ...
                    OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                        ...
                        EventsTestsUtil.assertCreateEvent(global.tests.admins.cam2013.client, 'Test event', start, end, opts, function(createdEvent) {
        ...
        it('verify an event can be created under one or more series', function(callback) {
            // Create a few series
            SeriesTestsUtil.assertCreateSerie(global.tests.admins.cam2013.client, 'Test serie', null, function(serieA) {
                SeriesTestsUtil.assertCreateSerie(global.tests.admins.cam2013.client, 'Test serie', null, function(serieB) {
                    SeriesTestsUtil.assertCreateSerie(global.tests.admins.cam2013.client, 'Test serie', null, function(serieC) {

                        // Create an event under one serie
                        var start = moment().format();
                        var end = moment().add(2, 'hour').format();
                        var opts = {'series': [serieA.id]};
                        EventsTestsUtil.assertCreateEvent(global.tests.admins.cam2013.client, 'Test Event', start, end, opts, function(eventA) {

                            // Create an event under two series
                            opts.series = [serieB.id, serieC.id];
                            EventsTestsUtil.assertCreateEvent(global.tests.admins.cam2013.client, 'Test Event', start, end, opts, function(eventB) {

                                // Sanity-check the event was added to each serie
                                SeriesTestsUtil.assertGetSeriesEvents(global.tests.admins.cam2013.client, serieA.id, null, null, null, [eventA], function() {
                                    SeriesTestsUtil.assertGetSeriesEvents(global.tests.admins.cam2013.client, serieB.id, null, null, null, [eventB], function() {
                                        SeriesTestsUtil.assertGetSeriesEvents(global.tests.admins.cam2013.client, serieC.id, null, null, null, [eventB], function() {
                                            return callback();
                                        });
                                    });
                                });
        ...
        it('verify create events validation', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                // Missing displayName
                EventsTestsUtil.assertCreateEventFails(simon.client, null, start, end, opts, 400, function() {

                    // Mising start date
                    EventsTestsUtil.assertCreateEventFails(simon.client, 'Test event', null, end, opts, 400, function() {

                        // Missing end date
                        EventsTestsUtil.assertCreateEventFails(simon.client, 'Test event', start, null, opts, 400, function() {

                            // Invalid start date
                            EventsTestsUtil.assertCreateEventFails(simon.client, 'Test event', 'bleh', end, opts, 400, function() {

                                // Invalid end date
                                EventsTestsUtil.assertCreateEventFails(simon.client, 'Test event', start, 'bleh', opts, 400, function() {

                                    // The start date cannot come after the end date
                                    EventsTestsUtil.assertCreateEventFails(simon.client, 'Test event', end, start, opts, 400, function() {
        ...
        it('verify create events authorization', function(callback) {
            ...
            TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                var start = moment().format();
                var end = moment().add(2, 'hour').format();
                EventsTestsUtil.assertCreateEventFails(anonymousClient, 'Test event', start, end, null, 401, function() {

                    // Regular users have to stick to creating events on their own tenant
                    TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                        var opts = {'app': global.tests.apps.cam2014.id};
                        EventsTestsUtil.assertCreateEventFails(simon.client, 'Test event', start, end, opts, 401, callback);
                    });
                });
            });
        });
        ...
        it('verify authorization when creating events under series', function(callback) {
            ...
            SeriesTestsUtil.assertCreateSerie(global.tests.admins.cam2013.client, 'Test serie', null, function(camSerie) {
                SeriesTestsUtil.assertCreateSerie(global.tests.admins.oxford2014.client, 'Test serie', null, function(oxSerie) {
                    ...
                    EventsTestsUtil.assertCreateEventFails(global.tests.admins.cam2013.client, 'Test event', start, end, opts, 401, function() {
                        ...
                        EventsTestsUtil.assertCreateEventFails(global.tests.admins.cam2013.client, 'Test event', start, end, opts, 401, function() {
                            ...
                            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                                SeriesTestsUtil.assertCreateSerie(simon.client, 'Test serie', null, function(simonSerie) {
                                    opts.series = [camSerie.id];
                                    EventsTestsUtil.assertCreateEventFails(simon.client, 'Test event', start, end, opts, 401, function() {
                                        // Sanity-check Simon can add the event to his own serie
                                        opts.series = [simonSerie.id];
                                        EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, opts, function() {
    ...
    describe('Getting an event', function() {
        ...
        it('verify getting an event', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(createdEvent) {
                    ...
                    // Retrieve it
                    EventsTestsUtil.assertGetEvent(simon.client, createdEvent.id, createdEvent, function(retrievedEvent) {
                        return callback();
                    });
                });
            });
        ...
        it('verify getting an event validation', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                // Invalid event id
                EventsTestsUtil.assertGetEventFails(simon.client, 'not a number', 400, function() {

                    // Unknown event id
                    EventsTestsUtil.assertGetEventFails(simon.client, -1, 404, function() {
                        return callback();
                    });
                });
            });
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                TestsUtil.generateTestUsers(global.tests.apps.cam2014, 1, false, function(nico) {
                    ...
                    EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(createdEvent) {
                        ...
                        EventsTestsUtil.assertGetEventFails(nico.client, createdEvent.id, 401, function() {

                            // Assert a global admin can retrieve it
                            TestsUtil.getGlobalAdminRestClient(function(adminClient) {
                                EventsTestsUtil.assertGetEvent(adminClient, createdEvent.id, createdEvent, function(retrievedEvent) {
                                    return callback();
                                });
                            });
                        });
        ...
        it('verify updating an event', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(createdEvent) {
                    ...
                    EventsTestsUtil.assertUpdateEvent(simon.client, createdEvent.id, update, function(updatedEvent) {

                        // Retrieve it
                        EventsTestsUtil.assertGetEvent(simon.client, createdEvent.id, updatedEvent, function(retrievedEvent) {
                            return callback();
                        });
                    });
                });
        ...
        it('verify updating an event validation', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(event) {
                    ...
                    // No updates
                    var update = {};
                    EventsTestsUtil.assertUpdateEventFails(simon.client, event.id, update, 400, function() {
                                            ...
                                            EventsTestsUtil.assertUpdateEventFails(simon.client, event.id, update, 400, function() {
                                                ...
                                                EventsTestsUtil.assertUpdateEventFails(simon.client, event.id, update, 400, function() {
                                                    ...
                                                    EventsTestsUtil.assertUpdateEventFails(simon.client, event.id, update, 400, function() {
                                                        ...
                                                        // Unknown group
                                                        update = {'group': -1};
                                                        EventsTestsUtil.assertUpdateEventFails(simon.client, event.id, update, 404, function() {
        ...
        it('verify updating an event authorization', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 4, false, function(simon, nico, sam, bert) {
                ...
                EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, opts, function(event) {
                    ...
                    TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                        EventsTestsUtil.assertUpdateEventFails(anonymousClient, event.id, update, 401, function() {
                            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                                EventsTestsUtil.assertUpdateEventFails(anonymousGlobalAdminClient, event.id, update, 401, function() {

                                    // Authenticated users unrelated to the event cannot update the event
                                    EventsTestsUtil.assertUpdateEventFails(bert.client, event.id, update, 401, function() {

                                        // App admins from another application cannot update the event
                                        EventsTestsUtil.assertUpdateEventFails(global.tests.admins.oxford2014.client, event.id, update, 401, function() {

                                            // Organisers can update the event
                                            EventsTestsUtil.assertUpdateEvent(nico.client, event.id, update, function() {
                                                ...
                                                GroupsTestsUtil.assertUpdateGroupMembers(simon.client, event.GroupId, membersUpdate, function() {
                                                    EventsTestsUtil.assertUpdateEvent(sam.client, event.id, update, function() {

                                                        // Application admins can update the event
                                                        EventsTestsUtil.assertUpdateEvent(global.tests.admins.cam2013.client, event.id, update, function() {

                                                            // Global admins can update the event
                                                            TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                                                                EventsTestsUtil.assertUpdateEvent(globalAdminClient, event.id, update, function() {
                                                                    return callback();
                                                                });
                                                            });
                                                        });
    ...
    describe('Deleting an event', function() {
        ...
        it('verify deleting an event', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                EventsTestsUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(createdEvent) {
                    ...
                    // Delete it
                    EventsTestsUtil.assertDeleteEvent(simon.client, createdEvent.id, function() {

                        // Try to retrieve the event, it should be gone
                        EventsTestsUtil.assertGetEventFails(simon.client, createdEvent.id, 404, callback);
                    });
                });
            });
        });
        ...
        it('verify deleting an event validation', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                // Invalid event id
                EventsTestsUtil.assertDeleteEventFails(simon.client, 'not a number', 400, function() {

                    // Unknown event id
                    EventsTestsUtil.assertDeleteEventFails(simon.client, -1, 404, callback);
                });
            });
        });
        ...
        var _deleteEvent = function(creator, organiser, extraGroupMember, deleterClient, expectFailure, callback) {
            ...
            EventsTestsUtil.assertCreateEvent(creator.client, 'Test event', start, end, opts, function(event) {

                // Add an extra group member
                var membersUpdate = {};
                membersUpdate[extraGroupMember.profile.id] = true;
                GroupsTestsUtil.assertUpdateGroupMembers(creator.client, event.GroupId, membersUpdate, function() {

                    // Try to delete the event
                    if (expectFailure) {
                        EventsTestsUtil.assertDeleteEventFails(deleterClient, event.id, 401, callback);
                    } else {
                        EventsTestsUtil.assertDeleteEvent(deleterClient, event.id, callback);
                    }
                });
            });
        };
