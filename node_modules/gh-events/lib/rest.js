...
GrassHopper.globalAdminServer.on('get', '/api/events/:id', getEvent);
GrassHopper.appServer.on('get', '/api/events/:id', getEvent);
 ...
 * @FormParam   {number}            end                 The timestamp (millis since epoch) at which the event ends
 * @FormParam   {number}            start               The timestamp (millis since epoch) at which the event starts
 ...
 */
GrassHopper.appServer.on('post', '/api/events', function(req, res) {
    res.send(501);
});
 ...
 * @Return      {Event}                                 The created event
 */
GrassHopper.globalAdminServer.on('post', '/api/events', function(req, res) {
    res.send(501);
});
 ...
 * @FormParam   {number}                [end]               The updated timestamp (millis since epoch) at which the event ends
 ...
 * @FormParam   {number}                [start]             The updated timestamp (millis since epoch) at which the event starts
...
GrassHopper.globalAdminServer.on('post', '/api/events/:id', updateEvent);
GrassHopper.appServer.on('post', '/api/events/:id', updateEvent);
...
GrassHopper.globalAdminServer.on('post', '/api/events/:id/organisers', updateEvent);
GrassHopper.appServer.on('post', '/api/events/:id/organisers', updateEvent);
...
GrassHopper.globalAdminServer.on('post', '/api/events/:id/picture', setEventPicture);
GrassHopper.appServer.on('post', '/api/events/:id/picture', setEventPicture);
...
GrassHopper.globalAdminServer.on('post', '/api/events/:id/picture/crop', cropEventPicture);
GrassHopper.appServer.on('post', '/api/events/:id/picture/crop', cropEventPicture);
...
GrassHopper.globalAdminServer.on('delete', '/api/events/:id', deleteEvent);
GrassHopper.appServer.on('delete', '/api/events/:id', deleteEvent);
...
GrassHopper.globalAdminServer.on('post', '/api/events/:id/subscribers', getEventSubscribers);
GrassHopper.appServer.on('post', '/api/events/:id/subscribers', getEventSubscribers);
...
GrassHopper.globalAdminServer.on('post', '/api/events/:id/subscribe', subscribeEvent);
GrassHopper.appServer.on('post', '/api/events/:id/subscribe', subscribeEvent);
