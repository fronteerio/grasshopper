...
module.exports = function(client) {
     ...
     * @param  {String}         [opts.description]              The description of the organisational unit
     * @param  {Number}         [opts.type]                     The organisational unit type (e.g. `course`, `subject`, `part`, `module`)
     ...
     * @see gh-orgunit/lib/rest.js for more information
     */
    client.orgUnit.addOrgUnitSeries = function(id, series, callback) {
        var data = {
            'serie': series
        };
        var url = '/api/orgunit/' + client.util.encodeURIComponent(id) + '/series';
     ...
     * @param  {String}         format                          The format in which the organisational units, event series and events should be exported. Defaults to `json`       [csv,json]
     * @param  {Function}       callback                        Standard callback function
     * @param  {Object}         callback.err                    An error that occurred, if any
     * @param  {Object}         callback.body                   The JSON response from the REST API
     * @param  {Response}       callback.response               The response object as returned by requestjs
     * @see gh-orgunit/lib/rest.js for more information
     */
    client.orgUnit.exportOrgUnit = function(id, format, callback) {
        var url = '/api/orgunit/' + client.util.encodeURIComponent(id) + '/export';
        client._request(url, 'GET', {'format': format}, null, callback);
    };

    /**
     * Import organisational units, event series and events under an organisational unit
     *
     * @param  {Number}         id                              The id of the organisational unit into which to import the data
     * @param  {Object}         importData                      The organisational units, event series and events to import
     ...
     * @see gh-orgunit/lib/rest.js for more information
     */
    client.orgUnit.importOrgUnit = function(id, importData, deleteMissing, callback) {
        var url = '/api/orgunit/' + client.util.encodeURIComponent(id) + '/import';
        var data = {
