...
module.exports = function(client) {
     ...
     *
     * @param  {String}         opts.displayName                The name of the user
     * @param  {String}         opts.email                      The email address for the user. This will be used for authentication when using the local authentiation strategy
     * @param  {String}         [opts.emailPreference]          The email preference for the user on the apps to which the user is added    [immediate,no]
     * @param  {String}         [opts.password]                 The password with which the user will authenticate. This is only required when using the local authentiation strategy
     ...
     * @param  {String}         [tenantId]                      The tenant to which the user should be added. This defaults to the tenant of the current app
     * @param  {Function}       callback                        Standard callback function
     * @param  {Object}         callback.err                    An error that occurred, if any
     * @param  {Object}         callback.body                   The JSON response from the REST API
     * @param  {Response}       callback.response               The response object as returned by requestjs
     */
    client.user.create = function(opts, tenantId, callback) {
        opts = opts || {};
        var data = {
