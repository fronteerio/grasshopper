...
module.exports = function(client) {
     ...
     *
     * @param  {Number}         id                              The id of the user to get the groups for
     * @param  {Number}         [limit]                         The maximum number of results to retrieve. Defaults to 25
     ...
     */
    client.group.getUserMemberships = function(id, limit, offset, callback) {
        var url = '/api/users/' + client.util.encodeURIComponent(id) + '/memberships';
        var data = {
            'limit': limit,
            'offset': offset
        };
