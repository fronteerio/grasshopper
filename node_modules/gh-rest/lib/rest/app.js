...
module.exports = function(client) {
    ...
    client.app.getApp = function(id, callback) {
        client._request('/api/apps/' + id, 'GET', null, null, callback);
    };
    ...
    client.app.getAppAdmins = function(id, limit, offset, callback) {
        ...
        client._request('/api/apps/' + id + '/admins', 'GET', opts, null, callback);
    };
    ...
    client.app.updateApp = function(id, opts, callback) {
        client._request('/api/apps/' + id, 'POST', opts, null, callback);
    };
    ...
    client.app.updateAppAdmins = function(id, adminUpdates, callback) {
        client._request('/api/apps/' + id + '/admins', 'POST', adminUpdates, null, callback);
    };
