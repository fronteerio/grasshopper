...
/**
 * Determine whether or not the user in context can get another user's calendar
 *
 * @param  {Context}    ctx                         Standard context object containing the current user and the current application
 * @param  {User}       user                        The user whose calendar should be retrieved
 ...
 */
var canGetUserCalendar = module.exports.canGetUserCalendar = function(ctx, user, callback) {
