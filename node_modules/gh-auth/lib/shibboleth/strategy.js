...
var AuthenticationUtil = require('gh-auth/lib/util');

/**
 * A Shibboleth passport authentication strategy
 *
 * @param  {Function}   verify                  A standard passport verify function that gets called to the user account can be retrieved or created
