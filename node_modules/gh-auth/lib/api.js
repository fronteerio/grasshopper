...
var registerLocalAuthentication = function() {
    passport.use(new LocalStrategy({'passReqToCallback': true}, function(req, username, password, done) {
        ...
        if (req.ghApp.isGlobalAdmin) {
            _validateLocalAdminCredentials(req.ghApp, username, password, done);
        ...
        // The user is logging in on a regular app
            ...
            validator.check(username, {'code': 400, 'msg': 'A valid username must be provided'}).isEmail();
 ...
 */
var _validateLocalAdminCredentials = function(app, username, password, done) {
