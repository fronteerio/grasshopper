...
GrassHopper.globalAdminServer.on('get', '/api/auth/signed/become', becomeUser);
GrassHopper.appServer.on('get', '/api/auth/signed/become', becomeUser);
 ...
 * @Return      {void}
 */
GrassHopper.appServer.on('post', '/api/auth/signed', function(req, res, next) {
    res.send(501);
});
