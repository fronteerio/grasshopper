        ...
        it('verify authorization of exchanging access tokens', function(callback) {
            AuthTestsUtil.assertCreateOauthClient(userAppAdminClient, TestsUtil.generateString(), REDIRECT_URI_VALID, null, function(oauthClient) {
                AuthTestsUtil.assertGrantOauthAuthCode(userAppAdminClient, oauthClient.id, null, function(authCode) {
                    ...
                    // Authorization
                    AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, null, oauthClient.secret, authCode, oauthClient.redirectUri, null, 401, function(userAppAdminBearerClient) {
                        AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, 'not an int', oauthClient.secret, authCode, oauthClient.redirectUri, null, 401, function(userAppAdminBearerClient) {
                            AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, CLIENT_ID_NONEXISTING, oauthClient.secret, authCode, oauthClient.redirectUri, null, 401, function(userAppAdminBearerClient) {
                                AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, oauthClient.id, null, authCode, oauthClient.redirectUri, null, 401, function(userAppAdminBearerClient) {
                                    AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, oauthClient.id, 'incorrect secret', authCode, oauthClient.redirectUri, null, 401, function(userAppAdminBearerClient) {
                                        AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, oauthClient.id, oauthClient.secret, null, oauthClient.redirectUri, null, 400, function(userAppAdminBearerClient) {
                                            AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, oauthClient.id, oauthClient.secret, 'incorrect code', oauthClient.redirectUri, null, 403, function(userAppAdminBearerClient) {
                                                AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, oauthClient.id, oauthClient.secret, authCode, null, null, 403, function(userAppAdminBearerClient) {
                                                    AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, oauthClient.id, oauthClient.secret, authCode, 'not a uri', null, 403, function(userAppAdminBearerClient) {
                                                        AuthTestsUtil.assertExchangeOauthAuthCodeFails(userAppAdminClient, oauthClient.id, oauthClient.secret, authCode, 'http://grasshopper.fronteer.io/incorrect/uri', null, 403, function(userAppAdminBearerClient) {
                                                            return callback();
                                                        });
                                                    });
                                                });
            ...
            AuthTestsUtil.assertCreateOauthClient(userAppAdminClient, TestsUtil.generateString(), REDIRECT_URI_VALID, null, function(oauthClient) {
                ...
                AuthTestsUtil.assertGrantOauthAuthCode(userAppClient, oauthClient.id, null, function(code1) {
                    AuthTestsUtil.assertGrantOauthAuthCode(userAppClient, oauthClient.id, null, function(code2) {
                        ...
                        AuthTestsUtil.assertExchangeOauthAuthCode(userAppAdminClient, oauthClient.id, oauthClient.secret, code1, oauthClient.redirectUri, null, function(bearerClient, firstToken) {
                            AuthTestsUtil.assertExchangeOauthAuthCode(userAppAdminClient, oauthClient.id, oauthClient.secret, code2, oauthClient.redirectUri, null, function(bearerClient, secondToken) {
                                AuthTestsUtil.assertExchangeOauthAuthCode(userAppAdminClient, oauthClient.id, oauthClient.secret, code1, oauthClient.redirectUri, null, function(bearerClient, thirdToken) {
                                    assert.strictEqual(firstToken, secondToken);
