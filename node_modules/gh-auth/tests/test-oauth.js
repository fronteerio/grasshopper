...
describe('Oauth authentication', function() {
    ...
    describe('Clients', function() {
        ...
        /**
         * Test that verifies validation and authorization for updating a client
         */
        it('verify validation and authorization of updating a client', function(callback) {
            // Create a client to test with
            AuthTestsUtil.assertCreateOauthClient(userAppAdminClient, TestsUtil.generateString(), REDIRECT_URI_VALID, null, function(userAppAdminOauthClient) {

                // Anonymous global admin user can't update a client
                AuthTestsUtil.assertUpdateOauthClientFails(anonymousGlobalAdminClient, userAppAdminOauthClient.id, {'redirectUri': REDIRECT_URI_VALID}, 401, function() {

                    // Anonymous app user can't update a client
                    AuthTestsUtil.assertUpdateOauthClientFails(anonymousAppClient, userAppAdminOauthClient.id, {'redirectUri': REDIRECT_URI_VALID}, 401, function() {

                        // Authenticated non-admin app user can't update a client
                        AuthTestsUtil.assertUpdateOauthClientFails(userAppClient, userAppAdminOauthClient.id, {'redirectUri': REDIRECT_URI_VALID}, 401, function() {

                            // Admin user can't update a client on another app
                            AuthTestsUtil.assertUpdateOauthClientFails(externalUserAppAdminClient, userAppAdminOauthClient.id, {'redirectUri': REDIRECT_URI_VALID}, 401, function() {

                                // At least one field is required for global admin
                                AuthTestsUtil.assertUpdateOauthClientFails(globalAdminClient, userAppAdminOauthClient.id, {}, 400, function() {

                                    // Redirect uri must be a valid uri for global admin
                                    AuthTestsUtil.assertUpdateOauthClientFails(globalAdminClient, userAppAdminOauthClient.id, {'redirectUri': 'invalid url lol'}, 400, function() {

                                        // At least one field is required for app admin
                                        AuthTestsUtil.assertUpdateOauthClientFails(userAppAdminClient, userAppAdminOauthClient.id, {}, 400, function() {

                                            // Redirect uri must be valid for app admin
                                            AuthTestsUtil.assertUpdateOauthClientFails(userAppAdminClient, userAppAdminOauthClient.id, {'redirectUri': 'invalid url lol'}, 400, function() {

                                                // Sanity check both global and user app admin can update clients normally
                                                AuthTestsUtil.assertUpdateOauthClient(globalAdminClient, userAppAdminOauthClient.id, {'redirectUri': REDIRECT_URI_VALID}, function() {
                                                    AuthTestsUtil.assertUpdateOauthClient(userAppAdminClient, userAppAdminOauthClient.id, {'redirectUri': REDIRECT_URI_VALID}, function() {
                                                        return callback();
                                                    });
                                                });
                                            });
    ...
    describe('Access Tokens', function() {
        ...
        /**
         * Test that verifies an admin can grant an authorization code for a user
         */
        it('verify exchanging an authorization code that was granted on behalf of a user', function(callback) {
            AuthTestsUtil.assertCreateOauthClient(userAppAdminClient, TestsUtil.generateString(), REDIRECT_URI_VALID, null, function(oauthClient) {
                AuthTestsUtil.assertGrantOauthAuthCode(userAppAdminClient, oauthClient.id, {'forUserId': userAppUser.id}, function(authCode) {

                    // While the session is anonymous, authentication happens through oauth client secret
                    AuthTestsUtil.assertExchangeOauthAuthCode(anonymousAppClient, oauthClient.id, oauthClient.secret, authCode, oauthClient.redirectUri, null, function(userAppBearerClient) {

                        // Ensure the me feed from the user's cookie session client and bearer token client are the same
                        UsersTestsUtil.assertGetMe(userAppClient, function(cookieMe) {
                            UsersTestsUtil.assertGetMe(userAppBearerClient, function(bearerMe) {
                                assert.deepEqual(cookieMe, bearerMe);
                                return callback();
                            });
                        });
        ...
        /**
         * Test that verifies a functional authorization code can be granted when redirection is
         * disabled in the request
         */
        it('verify exchanging an authorization code with redirect disabled', function(callback) {
            AuthTestsUtil.assertCreateOauthClient(userAppAdminClient, TestsUtil.generateString(), REDIRECT_URI_VALID, null, function(oauthClient) {
                AuthTestsUtil.assertGrantOauthAuthCode(userAppAdminClient, oauthClient.id, {'forUserId': userAppUser.id, 'redirect': false}, function(authCode) {
        ...
        /**
         * Test that verifies exchanging an expired authorization code fails
         */
        ...
        /**
         * Test that verifies access tokens can be listed for a user
         */
