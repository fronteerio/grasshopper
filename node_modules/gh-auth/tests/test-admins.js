            ...
            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousClient) {
                ...
                AuthTestsUtil.assertLoginFails(anonymousClient, 'administrator', 'wrong password', function() {
                    AuthTestsUtil.assertLoginFails(anonymousClient, 'wrong username', 'administrator', function() {
                        ...
                        // The global admin credentials can't be used to sign in on a regular application
                        TestsUtil.getAnonymousAppUserClient(global.tests.apps.oxford2014, function(anonymousAppClient) {
                            AuthTestsUtil.assertLoginFails(anonymousAppClient, 'administrator', 'administrator', function() {
                                return callback();
                            });
                        });
                    });
