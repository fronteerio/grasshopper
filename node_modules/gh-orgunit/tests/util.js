...
var createSimpleTree = module.exports.createSimpleTree = function(client, callback) {
    assertCreateOrgUnit(client, 'Engineering', 'course', null, function(course) {
        assertCreateOrgUnit(client, 'Computer Science', 'subject', {'parent': course.id}, function(subject) {
            assertCreateOrgUnit(client, 'I', 'part', {'parent': subject.id}, function(part) {
                assertCreateOrgUnit(client, 'Algorithms 1', 'module', {'parent': part.id}, function(module) {
