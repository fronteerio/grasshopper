 ...
 * @param  {Object|String}      [opts.metadata]                 The metadata of the organisational unit
 * @param  {String}             [opts.published]                The published flag of the organisational unit
 ...
 * @param  {Object|String}      [opts.metadata]                 Updated organisational unit metadata
 * @param  {String}             [opts.published]                Updated organisational unit published flag
 * @param  {Function}           callback                        Standard callback function
 * @throws {AssertionError}                                     Error thrown when an assertion failed
 */
...
var createSimpleTree = module.exports.createSimpleTree = function(client, callback) {
    assertCreateOrgUnit(client, 'Engineering', 'course', {'published': true}, function(course) {
        assertCreateOrgUnit(client, 'Computer Science', 'subject', {'parent': course.id, 'published': true}, function(subject) {
            assertCreateOrgUnit(client, 'I', 'part', {'parent': subject.id, 'published': true, 'metadata': {'url': 'google.com'}}, function(part) {
