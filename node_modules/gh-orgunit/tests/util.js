...
var assertOrgUnit = module.exports.assertOrgUnit = function(orgUnit, expectedOrgUnit) {
    ...
    assert.strictEqual(orgUnit.visibility, expectedOrgUnit.visibility);
...
var assertCreateOrgUnit = module.exports.assertCreateOrgUnit = function(client, displayName, type, opts, callback) {
    ...
    client.orgUnit.createOrgUnit(displayName, type, opts, function(err, createdOrgUnit, response) {
        ...
        if (opts.visibility) {
            assert.strictEqual(createdOrgUnit.visibility, opts.visibility);
        }
        if (opts.group) {
...
var createSimpleTree = module.exports.createSimpleTree = function(client, callback) {
    assertCreateOrgUnit(client, 'Engineering', 'course', {'visibility': 'published'}, function(course) {
        assertCreateOrgUnit(client, 'Computer Science', 'subject', {'parent': course.id, 'visibility': 'published'}, function(subject) {
            assertCreateOrgUnit(client, 'I', 'part', {'parent': subject.id, 'visibility': 'published', 'metadata': {'url': 'google.com'}}, function(part) {
                assertCreateOrgUnit(client, 'Algorithms 1', 'module', {'parent': part.id, 'visibility': 'draft'}, function(module) {
