...
describe('Organisational units', function() {
    ...
    describe('Subscribing', function() {
                                        ...
                                        OrgUnitTestsUtil.assertSubscribeOrgUnitFails(camUser.client, moduleUnit.id, oxfordUser.profile.id, 401, function() {
                                            ...
                                            OrgUnitTestsUtil.assertSubscribeOrgUnit(global.tests.admins.cam2013.client, partUnit.id, camUser.profile.id, function() {
                                                ...
                                                OrgUnitTestsUtil.assertSubscribeOrgUnitFails(global.tests.admins.cam2013.client, partUnit.id, oxfordUser.profile.id, 401, function() {
                                                    ...
                                                    OrgUnitTestsUtil.assertSubscribeOrgUnitFails(global.tests.admins.oxford2014.client, partUnit.id, oxfordUser.profile.id, 401, function() {
        ...
        /**
         * Test that verifies that subscribing to an organisational unit with borrowed series does not duplicate events in the user calendar
         */
        ...
        /**
         * Test that verifies that subscribing to an organisational unit is possible when already subscribed to a serie in the organisational unit
         */
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test orgunit 1', 'type', null, function(orgUnit) {
                    ...
                    SeriesTestsUtil.generateSerieWithEvents(global.tests.admins.cam2013.client, 3, 5, calendarStart, calendarEnd, function(series) {
                        ...
                        OrgUnitTestsUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, orgUnit.id, serieIds, null, function() {
    ...
    describe('Unsubscribing', function() {
        ...
        /**
         * Test that verifies that unsubscribing from an organisational unit only removes series and events from that organisational unit
         */
                    ...
                    OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit2, subjectUnit2, partUnit2, moduleUnit2, series2) {
                        ...
                        OrgUnitTestsUtil.assertSubscribeOrgUnit(simon.client, moduleUnit1.id, simon.profile.id, function() {
                            OrgUnitTestsUtil.assertSubscribeOrgUnit(simon.client, moduleUnit2.id, simon.profile.id, function() {
                                ...
                                var module1Events = _.union(series1[0].events, series1[1].events, series1[2].events, series1[3].events);
                                var module2Events = _.union(series2[0].events, series2[1].events, series2[2].events, series2[3].events);
                                var allEvents = _.union(module1Events, module2Events);
                                allEvents = _.sortBy(allEvents, 'start');

                                var calendarStart = _.first(allEvents).start;
                                var calendarEnd = _.last(allEvents).end;
        ...
        /**
         * Test that verifies that unsubscribing from an organisational unit can handle unsubscribed series
         */
