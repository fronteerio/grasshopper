            ...
            OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(createdOrgUnit) {
                ...
                SeriesTestUtil.assertCreateSerie(global.tests.admins.cam2013.client, 'Test serie', null, function(serie) {
                    ...
                    OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, createdOrgUnit.id, [serie.id], function() {
                        ...
                        OrgUnitTestUtil.assertGetOrgUnits(simon.client, null, true, null, null, function(orgUnits) {
                            ...
                            SeriesTestUtil.assertSubscribeSeries(simon.client, serie.id, simon.profile.id, function() {
