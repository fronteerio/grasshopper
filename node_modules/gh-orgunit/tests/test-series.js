                                        ...
                                        OrgUnitTestUtil.assertAddOrgUnitSeriesFails(simon.client, orgUnit.id, [serie.id], 401, function() {
                                            ...
                                            OrgUnitTestUtil.assertAddOrgUnitSeriesFails(global.tests.admins.oxford2014.client, orgUnit.id, [serie.id], 401, function() {
                                                ...
                                                GroupsTestsUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, orgUnit.GroupId, update, function() {
                                                    OrgUnitTestUtil.assertAddOrgUnitSeries(simon.client, orgUnit.id, [serie.id], function() {
                                                        return callback();
                                                    });
                                                });
                                            });
                ...
                SeriesTestsUtil.assertCreateSerie(global.tests.admins.cam2013.client, 'Test serie', null, function(serie) {
                    ...
                    OrgUnitTestUtil.assertAddOrgUnitSeriesFails(global.tests.admins.cam2013.client, 'not a number', [serie.id], 400, function() {
                        OrgUnitTestUtil.assertAddOrgUnitSeriesFails(global.tests.admins.cam2013.client, -1, [serie.id], 404, function() {
                            ...
                            // Empty series
                            OrgUnitTestUtil.assertAddOrgUnitSeriesFails(global.tests.admins.cam2013.client, orgUnit.id, [], 400, function() {
            ...
            OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit 1', 'module', null, function(orgUnit1) {
                OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit 2', 'module', null, function(orgUnit2) {
                    SeriesTestsUtil.assertCreateSerie(global.tests.admins.cam2013.client, 'Test serie', null, function(serie) {
                        ...
                        OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, orgUnit1.id, [serie.id], function() {
                            OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, orgUnit2.id, [serie.id], callback);
                        });
                    });
                });
            });
        ...
        TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
            ...
            OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(createdOrgUnit) {
                ...
                SeriesTestsUtil.assertCreateSerie(global.tests.admins.cam2013.client, 'Test serie', null, function(serie) {
                    ...
                    // Add the serie to the organisational unit
                    OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, createdOrgUnit.id, [serie.id], function() {
