...
describe('Organisational units', function() {
    ...
    describe('Creating organisational units', function() {
        ...
        it('verify creating an organisational unit', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(parentOrgUnit) {
                ...
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(childOrgUnit) {

                    // Sanity-check the organisational units are created
                    OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, null, null, null, null, function(orgUnits) {
        ...
        it('verify a group is created when no group is specified', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit1) {

                // A new group with only the admin user should've been created
                GroupsTestsUtil.assertGetGroupMembers(global.tests.admins.cam2013.client, orgUnit1.GroupId, null, null, [global.tests.admins.cam2013.profile], function(members) {

                    // If the group is specified, no new group should be created
                    var opts = {'group': orgUnit1.GroupId};
                    OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit 2', 'course', opts, function(orgUnit2) {
        ...
        it('verify creating an organisational unit validation', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, null, 'course', null, 400, function() {

                // Too long displayName
                OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, TestsUtil.generateString(257), 'course', null, 400, function() {

                    // Missing type
                    OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, 'Test orgunit', null, null, 400, function() {

                        // Too long type
                        OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, 'Test orgunit', TestsUtil.generateString(33), null, 400, function() {

                            // Too long description
                            var opts = {'description': TestsUtil.generateString(1001)};
                            OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, 'Test orgunit', 'course', opts, 400, function() {
                                ...
                                OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, 'Test orgunit', 'course', opts, 400, function() {
                                    ...
                                    // Unknown group
                                    opts = {'group': -1};
                                    OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, 'Test orgunit', 'course', opts, 404, function() {
                                        ...
                                        OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, 'Test orgunit', 'course', opts, 400, function() {
                                            ...
                                            OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, 'Test orgunit', 'course', opts, 404, function() {
                                                ...
                                                TestsUtil.getGlobalAdminRestClient(function(globalAdminRestClient) {
                                                    ...
                                                    OrgUnitTestsUtil.assertCreateOrgUnitFails(globalAdminRestClient, 'Test orgunit', 'course', opts, 400, function() {

                                                        // Unknown app
                                                        opts = {'app': -1};
                                                        OrgUnitTestsUtil.assertCreateOrgUnitFails(globalAdminRestClient, 'Test orgunit', 'course', opts, 404, function() {
        ...
        it('verify extra metadata can be set when creating organisational units', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test orgunit', 'course', opts, function(orgUnit) {
        ...
        it('verify creating a top-level organisational unit authorization', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                    OrgUnitTestsUtil.assertCreateOrgUnitFails(anonymousClient, 'Test orgunit', 'course', null, 401, function() {
                        TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalClient) {
                            var opts = {'app': global.tests.apps.cam2013.id};
                            OrgUnitTestsUtil.assertCreateOrgUnitFails(anonymousGlobalClient, 'Test orgunit', 'course', opts, 401, function() {

                                // Regular users can't create top-level organisational units either
                                OrgUnitTestsUtil.assertCreateOrgUnitFails(simon.client, 'Test orgunit', 'course', null, 401, function() {
                                    ...
                                    OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, 'Test orgunit', 'course', opts, 401, function() {
                                        return callback();
                                    });
                                });
                            });
        ...
        it('verify creating a non-top-level organisational unit authorization', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test orgunit', 'course', {}, function(parent) {
                    ...
                    TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                        OrgUnitTestsUtil.assertCreateOrgUnitFails(anonymousClient, 'Test orgunit', 'course', opts, 401, function() {
                            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalClient) {
                                OrgUnitTestsUtil.assertCreateOrgUnitFails(anonymousGlobalClient, 'Test orgunit', 'course', opts, 401, function() {

                                    // Regular users can't create non-top-level organisational units either
                                    OrgUnitTestsUtil.assertCreateOrgUnitFails(simon.client, 'Test orgunit', 'course', opts, 401, function() {
                                        ...
                                        OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2013.client, 'Test orgunit', 'course', opts, 400, function() {
                                            ...
                                            GroupsTestsUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, parent.GroupId, update, function() {
                                                opts = {'parent': parent.id, 'app': global.tests.apps.cam2013.id};
                                                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test orgunit', 'course', opts, function() {
                                                    return callback();
                                                });
                                            });
                                        });
        ...
        it('verify an organisational unit cannot be created with a parent from another application', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(parentOrgUnit) {
                ...
                OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2014.client, 'Test org unit', 'course', opts, 400, function() {
                    return callback();
                });
            });
        });
        ...
        it('verify an organisational unit cannot be created with a group from another application', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(parentOrgUnit) {
                ...
                OrgUnitTestsUtil.assertCreateOrgUnitFails(global.tests.admins.cam2014.client, 'Test org unit', 'course', opts, 401, function() {
                    return callback();
                });
            });
        });
    ...
    describe('Updating organisational units', function() {
        ...
        it('verify updating an organisational unit', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                ...
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit 2', 'course', null, function(otherOrgUnit) {
                    ...
                    OrgUnitTestsUtil.assertUpdateOrgUnit(global.tests.admins.cam2013.client, orgUnit.id, update, function(orgUnit) {

                        // Verify it has been updated
                        OrgUnitTestsUtil.assertGetOrgUnit(global.tests.admins.cam2013.client, orgUnit.id, false, function(orgUnit) {
        ...
        it('verify updating an organisational unit authorization', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                ...
                OrgUnitTestsUtil.assertGetOrgUnit(global.tests.admins.cam2013.client, orgUnit.id, false, function(orgUnit) {
                    ...
                    TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                        OrgUnitTestsUtil.assertUpdateOrgUnitFails(anonymousClient, orgUnit.id, update, 401, function() {
                            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousClient) {
                                OrgUnitTestsUtil.assertUpdateOrgUnitFails(anonymousClient, orgUnit.id, update, 401, function() {
                                    ...
                                    TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                                        OrgUnitTestsUtil.assertUpdateOrgUnitFails(simon.client, orgUnit.id, update, 401, function() {

                                            // Application administrators from another application cannot update the organisational unit
                                            OrgUnitTestsUtil.assertUpdateOrgUnitFails(global.tests.admins.oxford2014.client, orgUnit.id, update, 401, function() {
                                                ...
                                                OrgUnitTestsUtil.assertGetOrgUnit(global.tests.admins.cam2013.client, orgUnit.id, false, function(orgUnit) {
                                                    ...
                                                    GroupsTestsUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, orgUnit.GroupId, memberUpdate, function() {
                                                        OrgUnitTestsUtil.assertUpdateOrgUnit(simon.client, orgUnit.id, update, function() {
                                                            return callback();
                                                        });
                                                    });
                                                });
        ...
        it('verify updating an organisational unit validation', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                ...
                var update = {'displayName': 'foo'};
                OrgUnitTestsUtil.assertUpdateOrgUnitFails(global.tests.admins.cam2013.client, 'Not a number', update, 400, function() {
                    OrgUnitTestsUtil.assertUpdateOrgUnitFails(global.tests.admins.cam2013.client, -1, update, 404, function() {

                        // Too long displayName
                        update = {'type': TestsUtil.generateString(257)};
                        OrgUnitTestsUtil.assertUpdateOrgUnitFails(global.tests.admins.cam2013.client, orgUnit.id, update, 400, function() {
                            ...
                            OrgUnitTestsUtil.assertUpdateOrgUnitFails(global.tests.admins.cam2013.client, orgUnit.id, update, 400, function() {
                                ...
                                OrgUnitTestsUtil.assertUpdateOrgUnitFails(global.tests.admins.cam2013.client, orgUnit.id, update, 400, function() {
                                    ...
                                    OrgUnitTestsUtil.assertUpdateOrgUnitFails(global.tests.admins.cam2013.client, orgUnit.id, update, 400, function() {
                                        ...
                                        // Unknown group
                                        update = {'group': -1};
                                        OrgUnitTestsUtil.assertUpdateOrgUnitFails(global.tests.admins.cam2013.client, orgUnit.id, update, 404, function() {
        ...
        it('verify an organisational unit cannot be updated with a parent from another application', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(parentOrgUnit) {
                ...
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2014.client, 'Test org unit', 'course', null, function(orgUnit) {
                    ...
                    OrgUnitTestsUtil.assertUpdateOrgUnitFails(global.tests.admins.cam2014.client, orgUnit.id, update, 400, function() {
                        return callback();
                    });
                });
            });
    ...
    describe('Deleting organisational units', function() {
        ...
        it('verify deleting an organisational unit', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                ...
                OrgUnitTestsUtil.assertGetOrgUnit(global.tests.admins.cam2013.client, orgUnit.id, false, function(orgUnit) {
                    ...
                    // Delete it
                    OrgUnitTestsUtil.assertDeleteOrgUnit(global.tests.admins.cam2013.client, orgUnit.id, function() {

                        // Verify it was deleted
                        OrgUnitTestsUtil.assertGetOrgUnitFails(global.tests.admins.cam2013.client, orgUnit.id, false, 404, callback);
                    });
                });
            });
        });
        ...
        it('verify deleting an organisational unit authorization', function(callback) {
            ...
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test org unit', 'course', null, function(orgUnit) {
                ...
                OrgUnitTestsUtil.assertGetOrgUnit(global.tests.admins.cam2013.client, orgUnit.id, false, function(orgUnit) {
                    ...
                    TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                        OrgUnitTestsUtil.assertDeleteOrgUnitFails(anonymousClient, orgUnit.id, 401, function() {
                            TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousClient) {
                                OrgUnitTestsUtil.assertDeleteOrgUnitFails(anonymousClient, orgUnit.id, 401, function() {

                                    // Authenticated users cannot delete organisational units
                                    TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                                        OrgUnitTestsUtil.assertDeleteOrgUnitFails(simon.client, orgUnit.id, 401, function() {

                                            // Application administrators from another application cannot delete the organisational unit
                                            OrgUnitTestsUtil.assertDeleteOrgUnitFails(global.tests.admins.oxford2014.client, orgUnit.id, 401, function() {
                                                ...
                                                OrgUnitTestsUtil.assertGetOrgUnit(global.tests.admins.cam2013.client, orgUnit.id, false, function(orgUnit) {
                                                    ...
                                                    GroupsTestsUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, orgUnit.GroupId, update, function() {
                                                        OrgUnitTestsUtil.assertDeleteOrgUnit(simon.client, orgUnit.id, function() {
                                                            return callback();
                                                        });
                                                    });
                                                });
        ...
        it('verify deleting an organisational unit validation', function(callback) {
            // Invalid organisational unit id
            OrgUnitTestsUtil.assertDeleteOrgUnitFails(global.tests.admins.cam2013.client, 'Not a number', 400, function() {
                OrgUnitTestsUtil.assertDeleteOrgUnitFails(global.tests.admins.cam2013.client, -1, 404, function() {
                    return callback();
                });
            });
        });
    ...
    describe('Getting the organisational units in an app', function() {
        ...
        it('verify getting the organisational units in an app', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit, series) {
                    ...
                    OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, null, true, null, null, function(orgUnits) {
                        ...
                        OrgUnitTestsUtil.assertOrgUnit(course, courseUnit);
                        OrgUnitTestsUtil.assertOrgUnit(subject, subjectUnit);
                        OrgUnitTestsUtil.assertOrgUnit(part, partUnit);
                        OrgUnitTestsUtil.assertOrgUnit(module, moduleUnit);
                        ...
                        OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, true, true, partUnit.id, null, function(orgUnits) {
        ...
        it('verify getting the organisational units in an app validation', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                // Invalid application
                OrgUnitTestsUtil.assertGetOrgUnitsFails(global.tests.admins.cam2013.client, 'not a number', null, null, null, null, 400, function(orgUnits) {

                    // Unknown parent
                    OrgUnitTestsUtil.assertGetOrgUnitsFails(global.tests.admins.cam2013.client, null, null, null, -1, null, 404, function(orgUnits) {

                        // Invalid type
                        OrgUnitTestsUtil.assertGetOrgUnitsFails(global.tests.admins.cam2013.client, null, null, null, null, TestsUtil.generateString(33), 400, function(orgUnits) {
                            OrgUnitTestsUtil.assertGetOrgUnitsFails(global.tests.admins.cam2013.client, null, null, null, null, ['ok', TestsUtil.generateString(33)], 400, function(orgUnits) {
        ...
        it('verify getting the organisational units in an app authorization', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit) {

                    // Getting the organisational units from another app is not allowed
                    OrgUnitTestsUtil.assertGetOrgUnitsFails(global.tests.admins.cam2014.client, global.tests.apps.cam2013.id, null, null, true, null, 401, function(orgUnits) {
                        ...
                        OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, null, true, null, null, function(orgUnits) {
                            ...
                            TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                                OrgUnitTestsUtil.assertGetOrgUnits(anonymousClient, null, null, true, null, null, function(orgUnits) {
                                    _.each(orgUnits.results, function(orgUnit) {
                                        assert.ok(_.has(orgUnit, 'canManage'));
                                    ...
                                    OrgUnitTestsUtil.assertGetOrgUnits(simon.client, null, null, true, null, null, function(orgUnits) {
                                        _.each(orgUnits.results, function(orgUnit) {
                                            assert.ok(_.has(orgUnit, 'canManage'));
                                            assert.strictEqual(orgUnit.canManage, false);
                                        });
                                        ...
                                        var update = {};
                                        update[simon.profile.id] = true;
                                        GroupsTestsUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, moduleUnit.GroupId, update, function() {
                                            OrgUnitTestsUtil.assertGetOrgUnits(simon.client, null, null, true, null, null, function(orgUnits) {
                                                _.each(orgUnits.results, function(orgUnit) {
                                                    assert.ok(_.has(orgUnit, 'canManage'));
        ...
        var expectSeries = function(client, parent, child, serieA, serieB, canManageSerieA, canManageSerieB, callback) {
            OrgUnitTestsUtil.assertGetOrgUnits(client, parent.AppId, true, true, parent.id, null, function(orgUnits) {
                assert.strictEqual(orgUnits.results.length, 1);
        ...
        it('verify the canManage property on series', function(callback) {
            // Create some test data
            OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2014.client, 'Parent', 'part', null, function(parent) {
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2014.client, 'Module', 'module', {'parent': parent.id}, function(module) {
                    ...
                    TestsUtil.generateTestUsers(global.tests.apps.cam2014, 3, false, function(simon, nico, sam) {
                        ...
                        SeriesTestsUtil.generateSerieWithEvents(simon.client, 1, 5, start, end, function(simonSeries) {
                            SeriesTestsUtil.generateSerieWithEvents(nico.client, 1, 5, start, end, function(nicoSeries) {

                                // Add each serie to the module
                                var serieIds = [simonSeries[0].id, nicoSeries[0].id];
                                OrgUnitTestsUtil.assertAddOrgUnitSeries(global.tests.admins.cam2014.client, module.id, serieIds, function() {
        ...
        it('verify using an organisational unit from another application as parent is not allowed', function(callback) {
            ...
            OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2014.client, function(courseUnit, subjectUnit, partUnit, moduleUnit) {

                // Verify we cannot use the 2014 data as a parent in the 2013 app
                OrgUnitTestsUtil.assertGetOrgUnitsFails(global.tests.admins.cam2013.client, null, null, null, courseUnit.id, null, 401, function(orgUnits) {
                    return callback();
                });
            });
        });
        ...
        it('verify filtering the organisational units in an app by type', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit) {
                    ...
                    OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, null, null, null, 'part', function(orgUnits) {
                        ...
                        OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, null, null, null, ['subject', 'part'], function(orgUnits) {
        ...
        it('verify getting the organisational units in an app under a parent', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit) {
                    ...
                    OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, null, null, courseUnit.id, null, function(orgUnits) {
        ...
        it('verify series can be included in the response', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit, series) {
                    ...
                    SeriesTestsUtil.generateSeries(global.tests.admins.cam2013.client, 30, function(extraSeries) {
                        var serieIds = _.pluck(extraSeries, 'id').sort();
                        OrgUnitTestsUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, moduleUnit.id, serieIds, function() {

                            // Get the the organisational units under the part AND include the series
                            OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, true, null, partUnit.id, null, function(orgUnits) {
        ...
        /**
         * Test that verifies that organisational units without series are not filtered out when including series
         */
        it('verify that organisational units without series are not filtered out when including series', function(callback) {
            // Generate a structure where there is a mix of organisational units with and without series
            OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, orgUnitWithSeries, series) {
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test', 'module', null, function(orgUnitWithoutSeries) {

                    // Get the organisational units including their series
                    OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, true, null, null, 'module', function(orgUnits) {

                        // Verify the organisational unit with associated series is returned
                        var resultWithSeries = _.find(orgUnits.results, {'id': orgUnitWithSeries.id});
                        assert.ok(resultWithSeries);
                        assert.ok(resultWithSeries.Series);
                        assert.strictEqual(resultWithSeries.Series.length, series.length);

                        // Verify the organisational unit without associated series is returned
                        var resultWithoutSeries = _.find(orgUnits.results, {'id': orgUnitWithoutSeries.id});
                        assert.ok(resultWithoutSeries);
                        assert.ok(_.isEmpty(resultWithoutSeries.Series));
                        return callback();
                    });
                });
            });
        ...
        /**
         * Test that verifies that the organisational unit a series is borrowed from is included in the response
         */
        it('verify the organisational unit a series is borrowed from is included in the response', function(callback) {
            // Generate a structure where a series is borrowed under multiple organisational units
            OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit1, series) {
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, '#2', 'module', null, function(moduleUnit2) {
                    OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, '#2', 'module', null, function(moduleUnit3) {
                        var seriesToAdd = series[0];
                        OrgUnitTestsUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, moduleUnit2.id, [seriesToAdd.id], function() {
                            OrgUnitTestsUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, moduleUnit3.id, [seriesToAdd.id], function() {

                                OrgUnitTestsUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, true, null, null, 'module', function(orgUnits) {

                                    // There's no borrowing taking place in module 1 as it was the first organisational
                                    // unit to add the series. The `borrowedFrom` key should not be present
                                    var moduleUnit1Response = _.find(orgUnits.results, {'id': moduleUnit1.id});
                                    var series = _.find(moduleUnit1Response.Series, {'id': seriesToAdd.id});
                                    assert.ok(!series.borrowedFrom);

                                    // Assert that module 2 is borrowing the series from module 1
                                    var moduleUnit2Response = _.find(orgUnits.results, {'id': moduleUnit2.id});
                                    series = _.find(moduleUnit2Response.Series, {'id': seriesToAdd.id});
                                    assert.ok(series.borrowedFrom);
                                    assert.strictEqual(series.borrowedFrom.id, moduleUnit1.id);
                                    var allowedKeys = ['id', 'displayName', 'ParentId'].sort();
                                    assert.deepEqual(_.keys(series.borrowedFrom).sort(), allowedKeys);

                                    // Assert that module 2 is borrowing the series from module 1
                                    var moduleUnit3Response = _.find(orgUnits.results, {'id': moduleUnit3.id});
                                    series = _.find(moduleUnit3Response.Series, {'id': seriesToAdd.id});
                                    assert.ok(series.borrowedFrom);
                                    assert.strictEqual(series.borrowedFrom.id, moduleUnit1.id);
                                    assert.deepEqual(_.keys(series.borrowedFrom).sort(), allowedKeys);
                                    return callback();
    ...
    describe('Getting an organisational unit', function() {
        ...
        it('verify getting an organisational unit', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestsUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit, series) {
                    ...
                    OrgUnitTestsUtil.assertGetOrgUnit(simon.client, courseUnit.id, false, function(orgUnit) {
                        OrgUnitTestsUtil.assertOrgUnit(orgUnit, courseUnit);

                        // Verify series can be included
                        OrgUnitTestsUtil.assertGetOrgUnit(simon.client, moduleUnit.id, true, function(orgUnit) {
                            ...
                            _.each(orgUnit.series, function(serie) {
                                SeriesTestsUtil.assertSerie(serie, expectedSeriesById[serie.id]);
                            });
        ...
        it('verify validation when getting an organisational unit', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                // Invalid organisational unit id
                OrgUnitTestsUtil.assertGetOrgUnitFails(simon.client, 'not a number', false, 400, function() {

                    // Unknown organisational unit id
                    OrgUnitTestsUtil.assertGetOrgUnitFails(simon.client, -1, false, 404, function() {
                        OrgUnitTestsUtil.assertGetOrgUnitFails(simon.client, 12312312, false, 404, function() {
                            return callback();
                        });
                    });
                });
        ...
        it('verify authorization when getting an organisational unit', function(callback) {
            ...
            OrgUnitTestsUtil.createSimpleTree(global.tests.admins.oxford2014.client, function(courseUnit, subjectUnit, partUnit, moduleUnit, series) {

                // Anonymous users from other applications can't access the organisational unit
                TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                    OrgUnitTestsUtil.assertGetOrgUnitFails(anonymousClient, courseUnit.id, false, 401, function() {
                        ...
                        TestsUtil.getAnonymousAppUserClient(global.tests.apps.oxford2014, function(anonymousOxfordClient) {
                            OrgUnitTestsUtil.assertGetOrgUnit(anonymousOxfordClient, courseUnit.id, false, function() {
                                ...
                                TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(camUser) {
                                    OrgUnitTestsUtil.assertGetOrgUnitFails(camUser.client, courseUnit.id, false, 401, function() {
                                        ...
                                        TestsUtil.generateTestUsers(global.tests.apps.oxford2014, 1, false, function(oxfordUser) {
                                            OrgUnitTestsUtil.assertGetOrgUnit(oxfordUser.client, courseUnit.id, false, function() {

                                                // Application admins from other applications can't access the organisational unit
                                                OrgUnitTestsUtil.assertGetOrgUnitFails(global.tests.admins.cam2013.client, courseUnit.id, false, 401, function() {

                                                    // Application admins from the same application can access the organisational unit
                                                    OrgUnitTestsUtil.assertGetOrgUnit(global.tests.admins.oxford2014.client, courseUnit.id, false, function() {

                                                        // Anonymous users on the global admin application can't access the organisational unit
                                                        TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalClient) {
                                                            OrgUnitTestsUtil.assertGetOrgUnitFails(anonymousGlobalClient, courseUnit.id, false, 401, function() {

                                                                // Global admins can access the organisational unit
                                                                TestsUtil.getGlobalAdminRestClient(function(globalAdminRestClient) {
                                                                    OrgUnitTestsUtil.assertGetOrgUnit(globalAdminRestClient, courseUnit.id, false, function() {
                                                                        return callback();
                                                                    });
                                                                });
                                                            });
