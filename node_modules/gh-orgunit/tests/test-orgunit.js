            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestUtil.assertGetOrgUnitsFails(global.tests.admins.cam2013.client, 'not a number', null, null, null, 400, function(orgUnits) {
                    ...
                    OrgUnitTestUtil.assertGetOrgUnitsFails(global.tests.admins.cam2013.client, null, null, -1, null, 404, function(orgUnits) {
                        ...
                        // Invalid type
                        OrgUnitTestUtil.assertGetOrgUnitsFails(global.tests.admins.cam2013.client, null, null, null, TestsUtil.generateString(33), 400, function(orgUnits) {
                            OrgUnitTestUtil.assertGetOrgUnitsFails(global.tests.admins.cam2013.client, null, null, null, ['ok', TestsUtil.generateString(33)], 400, function(orgUnits) {
        ...
        it('verify series can be included in the response', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                _createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit) {
                    ...
                    // Generate a lot of series to ensure paging does not take place
                    SeriesTestUtil.generateSeries(global.tests.admins.cam2013.client, 30, function(series) {
                        var serieIds = _.pluck(series, 'id').sort();
                        OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, moduleUnit.id, serieIds, function() {
                            ...
                            OrgUnitTestUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, true, partUnit.id, null, function(orgUnits) {
                                ...
                                assert.strictEqual(orgUnits.results[0].Series.length, 30);
