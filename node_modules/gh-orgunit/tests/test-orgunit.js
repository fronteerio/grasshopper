...
describe('Organisational units', function() {
    ...
    describe('Getting the organisational units in an app', function() {
                    ...
                    TestsUtil.generateTestUsers(global.tests.apps.cam2014, 3, false, function(simon, nico, sam) {
                        ...
                        SeriesTestsUtil.generateSerieWithEvents(simon.client, 1, 5, start, end, function(simonSeries) {
                            SeriesTestsUtil.generateSerieWithEvents(nico.client, 1, 5, start, end, function(nicoSeries) {
                                ...
                                OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2014.client, module.id, serieIds, function() {
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit, series) {
                    ...
                    SeriesTestsUtil.generateSeries(global.tests.admins.cam2013.client, 30, function(extraSeries) {
                        ...
                        OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, moduleUnit.id, serieIds, function() {
        ...
        it('verify that organisational units without series are not filtered out when including series', function(callback) {
            ...
            OrgUnitTestUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, orgUnitWithSeries, series) {
                OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test', 'module', null, function(orgUnitWithoutSeries) {

                    // Get the organisational units including their series
                    OrgUnitTestUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, true, null, null, 'module', function(orgUnits) {
        ...
        it('verify the organisational unit a series is borrowed from is included in the response', function(callback) {
            ...
            OrgUnitTestUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, moduleUnit1, series) {
                OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, '#2', 'module', null, function(moduleUnit2) {
                    OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, '#2', 'module', null, function(moduleUnit3) {
                        var seriesToAdd = series[0];
                        OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, moduleUnit2.id, [seriesToAdd.id], function() {
                            OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, moduleUnit3.id, [seriesToAdd.id], function() {
