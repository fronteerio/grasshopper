...
describe('Organisational units', function() {
    ...
    describe('Getting the organisational units in an app', function() {
        ...
        it('verify that organisational units without series are not filtered out when including series', function(callback) {
            // Generate a structure where there is a mix of organisational units with or without series
            OrgUnitTestUtil.createSimpleTree(global.tests.admins.cam2013.client, function(courseUnit, subjectUnit, partUnit, orgUnitWithSeries, series) {
                OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Test', 'module', null, function(orgUnitWithoutSeries) {
                    ...
                    OrgUnitTestUtil.assertGetOrgUnits(global.tests.admins.cam2013.client, null, true, null, null, 'module', function(orgUnits) {
                        ...
                        // Verify the organisational unit with some series associated to it gets returned
                        ...
                        // Verify the organisational unit without associated series gets returned
