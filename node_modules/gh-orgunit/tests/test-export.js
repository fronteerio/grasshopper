                                    ...
                                    OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, module.id, [series.id], function() {
                                        ...
                                        OrgUnitTestUtil.assertExportOrgUnit(global.tests.admins.cam2013.client, root.id, null, function(data) {
                                            ...
                                            OrgUnitTestUtil.assertExportOrgUnit(global.tests.admins.cam2013.client, root.id, 'csv', function(records) {
                                                ...
                                                // Expected keys
                                                var expectedColumns = [
                                                    'course_id', 'course_externalId', 'course_displayName', 'course_description', 'course_published', 'course_ParentId',
                                                    'part_id', 'part_externalId', 'part_displayName', 'part_description', 'part_published', 'part_ParentId',
                                                    'module_id', 'module_externalId', 'module_displayName', 'module_description', 'module_published', 'module_ParentId',
