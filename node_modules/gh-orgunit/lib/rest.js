 ...
 *
 * The data can be exported in JSON or CSV. The JSON export format is fairly straightforward and
 * contains nested organisational units. The CSV format is not entirely non-trivial and requires
