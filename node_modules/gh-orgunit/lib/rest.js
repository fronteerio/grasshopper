 ...
 * @FormParam   {number}            [fromOrgUnit]       The id of the organisational unit the series is borrowed from
 * @Return      {void}
 */
var addOrgUnitSeries = function(req, res) {
    var series = GrassHopperUtil.toArray(req.body.serie);
    OrgUnitAPI.addOrgUnitSeries(req.ctx, req.params.id, series, req.body.fromOrgUnit, function(err) {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
