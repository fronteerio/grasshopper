 ...
 */
var getOrgUnits = function(req, res) {
...
GrassHopper.appRouter.on('get', '/api/orgunit', getOrgUnits);
GrassHopper.globalAdminRouter.on('get', '/api/orgunit', getOrgUnits);
...
GrassHopper.globalAdminRouter.on('get', '/api/orgunit/:id', getOrgUnit);
GrassHopper.appRouter.on('get', '/api/orgunit/:id', getOrgUnit);
...
GrassHopper.globalAdminRouter.on('get', '/api/orgunit/:id/series', getOrgUnitSeries);
GrassHopper.appRouter.on('get', '/api/orgunit/:id/series', getOrgUnitSeries);
...
GrassHopper.globalAdminRouter.on('get', '/api/orgunit/:id/calendar', getOrgUnitCalendar);
GrassHopper.appRouter.on('get', '/api/orgunit/:id/calendar', getOrgUnitCalendar);
...
GrassHopper.globalAdminRouter.on('get', '/api/orgunit/:id/calendar.ical', getOrgUnitCalendarIcal);
GrassHopper.appRouter.on('get', '/api/orgunit/:id/calendar.ical', getOrgUnitCalendarIcal);
...
GrassHopper.globalAdminRouter.on('get', '/api/orgunit/:id/calendar.rss', getOrgUnitCalendarRss);
GrassHopper.appRouter.on('get', '/api/orgunit/:id/calendar.rss', getOrgUnitCalendarRss);
...
GrassHopper.globalAdminRouter.on('get', '/api/orgunit/:id/upcoming', getOrgUnitUpcoming);
GrassHopper.appRouter.on('get', '/api/orgunit/:id/upcoming', getOrgUnitUpcoming);
 ...
 * @Return      {OrgUnit}                               The created organisational unit
 */
var createOrgUnit = function(req, res) {
...
GrassHopper.appRouter.on('post', '/api/orgunit', createOrgUnit);
GrassHopper.globalAdminRouter.on('post', '/api/orgunit', createOrgUnit);
...
GrassHopper.globalAdminRouter.on('post', '/api/orgunit/:id', updateOrgUnit);
GrassHopper.appRouter.on('post', '/api/orgunit/:id', updateOrgUnit);
...
GrassHopper.globalAdminRouter.on('post', '/api/orgunit/:id/series', addOrgUnitSeries);
GrassHopper.appRouter.on('post', '/api/orgunit/:id/series', addOrgUnitSeries);
...
GrassHopper.globalAdminRouter.on('post', '/api/orgunit/:id/events', addOrgUnitEvents);
GrassHopper.appRouter.on('post', '/api/orgunit/:id/events', addOrgUnitEvents);
...
GrassHopper.globalAdminRouter.on('delete', '/api/orgunit/:id/series', deleteOrgUnitSeries);
GrassHopper.appRouter.on('delete', '/api/orgunit/:id/series', deleteOrgUnitSeries);
...
GrassHopper.globalAdminRouter.on('delete', '/api/orgunit/:id/events', deleteOrgUnitEvents);
GrassHopper.appRouter.on('delete', '/api/orgunit/:id/events', deleteOrgUnitEvents);
...
GrassHopper.globalAdminRouter.on('delete', '/api/orgunit/:id', deleteOrgUnit);
GrassHopper.appRouter.on('delete', '/api/orgunit/:id', deleteOrgUnit);
...
GrassHopper.globalAdminRouter.on('post', '/api/orgunit/:id/subscribe', subscribeOrgUnit);
GrassHopper.appRouter.on('post', '/api/orgunit/:id/subscribe', subscribeOrgUnit);
 ...
 * @Return      {void}
 */
var unsubscribeOrgUnit = function(req, res) {
...
GrassHopper.globalAdminRouter.on('post', '/api/orgunit/:id/unsubscribe', unsubscribeOrgUnit);
GrassHopper.appRouter.on('post', '/api/orgunit/:id/unsubscribe', unsubscribeOrgUnit);
 ...
 *
 * The CSV export will use the `type` of the organisational units as the column headers. This adds
 * the restriction that a type can only occur on one level of the tree. If a type occurs on two
 * different levels, the export endpoint will return a 400 error and refuse to export the tree to CSV.
 *
 ...
 * ```
 *
 * As the last example, the input tree will be chaned. In the previous examples the input tree was
 * nicely structured with series and events always at the bottom. This doesn't necessarily have to be
 * the case. Series and events can be attached to any organisational unit. It's still required that
 * organisational unit types are on the same level however
 *
 * ```
 ...
 */
var exportOrgUnit = function(req, res) {
...
GrassHopper.globalAdminRouter.on('get', '/api/orgunit/:id/export', exportOrgUnit);
GrassHopper.appRouter.on('get', '/api/orgunit/:id/export', exportOrgUnit);
