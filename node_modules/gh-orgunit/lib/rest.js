 ...
 * @FormParam   {object}            [metadata]          The metadata of the organisational unit
 * @FormParam   {number}            [parent]            The id of the parent organisational unit
 * @FormParam   {string}            [visibility]        The visibility of the organisational unit               [draft,published]
 ...
 * @FormParam   {string}            [description]       The description of the organisational unit
 * @FormParam   {string}            [metadata]          The metadata of the organisational unit
 * @FormParam   {number}            [group]             The id of the group that can manage the organisational unit. Defaults to creating a new group with the current user as a member
 * @FormParam   {number}            [parent]            The id of the parent organisational unit
 * @FormParam   {string}            [visibility]        The visibility of the organisational unit               [draft,published]
 * @Return      {OrgUnit}                               The created organisational unit
...
var createOrgUnit = function(req, res) {
    ...
    OrgUnitAPI.createOrgUnit(req.ctx, appId, req.body.displayName, req.body.type, req.body.description, req.body.metadata, req.body.visibility, req.body.group, req.body.parent, function(err, orgUnit) {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
