 ...
 */
GrassHopper.appRouter.on('get', '/api/orgunit', function(req, res) {
    res.sendStatus(501);
});
 ...
 */
GrassHopper.globalAdminRouter.on('get', '/api/orgunit', function(req, res) {
    res.sendStatus(501);
});
 ...
 */
GrassHopper.appRouter.on('post', '/api/orgunit', function(req, res) {
    res.sendStatus(501);
});
 ...
 * @Return      {OrgUnit}                               The created organisational unit
 */
GrassHopper.globalAdminRouter.on('post', '/api/orgunit', function(req, res) {
    res.sendStatus(501);
});
