 ...
 * @param  {Function}   callback                    Standard callback function
 * @param  {Object}     callback.err                An error object, if any
 * @param  {Number[]}   callback.allOrgUnitIds      The ids of the organisational units that are part of the trees (including the original root ids)
 * @api private
 */
 ...
 * @param  {Function}   callback                    Standard callback function
 * @param  {Object}     callback.err                An error object, if any
 * @param  {Number[]}   callback.allOrgUnitIds      The ids of the organisational units that are direct children of the given set of organisational unit ids
 * @api private
 */
