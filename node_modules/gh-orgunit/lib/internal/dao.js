 ...
 * @param  {OrgUnit}        callback.orgUnit    The created organisational unit
 */
var getOrgUnitSeries = module.exports.getOrgUnitSeries = function(id, limit, offset, upcoming, callback) {
    var options = {
        'where': {'OrgUnitId': id},
        'limit': limit,
        'offset': offset
...
var addOrgUnitSeries = module.exports.addOrgUnitSeries = function(orgUnit, series, callback) {
    orgUnit.addSeries(series).complete(function(err) {
        if (err) {
            log().error({'err': err, 'id': orgUnit.id}, 'Unable to add series to an organisational unit');
 ...
 *
 * @param  {OrgUnit}        orgUni              The organisational unit to remove the serie(s) from
...
var deleteOrgUnitSeries = module.exports.deleteOrgUnitSeries = function(orgUnit, series, callback) {
    orgUnit.removeSeries(series).complete(function(err) {
        if (err) {
            log().error({'err': err, 'id': orgUnit.id}, 'Unable to remove series from an organisational unit');
