...
var _updateOrCreateOrgUnit = function(appId, orgUnitToImport, parent, callback) {
    if (orgUnitToImport.id) {
        ...
        return createOrgUnit(appId, orgUnitToImport.displayName, orgUnitToImport.type, parent.GroupId, opts, callback);
    }
};
...
var _updateOrCreateSeries = function(appId, seriesToImport, orgUnit, callback) {
    ...
    if (seriesToImport.id) {
        ...
        // Create the series
        return SeriesDAO.createSeries(appId, seriesToImport.displayName, seriesToImport.description, orgUnit.GroupId, seriesToImport.externalId, callback);
    }
};
