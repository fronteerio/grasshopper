...
var createOrgUnit = module.exports.createOrgUnit = function(ctx, appId, displayName, type, description, groupId, parentId, callback) {
    ...
    validator.check(type, {'code': 400, 'msg': 'A type can be at most 16 characters long'}).len(1, 16);
    if (description) {
        validator.check(description, {'code': 400, 'msg': 'A description can be at most 256 characters long'}).isMediumString();
    }
    if (groupId) {
...
var updateOrgUnit = module.exports.updateOrgUnit = function(ctx, id, opts, callback) {
    ...
    if (opts) {
        ...
        if (opts.type) {
            ...
            validator.check(opts.type, {'code': 400, 'msg': 'A type can be at most 16 characters long'}).len(1, 16);
            update.type = opts.type;
        }
        if (opts.description) {
            validator.check(opts.description, {'code': 400, 'msg': 'A description can be at most 256 characters long'}).isMediumString();
