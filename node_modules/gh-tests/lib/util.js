 ...
 * The returned string will be formatted as `address:port`
 *
 * @return {String} The address and port on which the global administration server is listening formatted
 */
var getListenAdminAddress = module.exports.getListenAdminAddress = function() {
 ...
 */
var getListenAppAddress = module.exports.getListenAppAddress = function() {
    var config = getConfig();
