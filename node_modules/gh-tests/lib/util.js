...
var generateTestApp = module.exports.generateTestApp = function(tenantId, callback) {
    ...
    getGlobalAdminRestClient(function(globalAdminClient) {
        globalAdminClient.app.createApp(tenantId, displayName, host, 'timetable', function(err, app) {
            return callback(app);
        });
    });
};
 ...
 */
var generateTestUsers = module.exports.generateTestUsers = function(app, total, isAdmin, callback, _createdUsers) {
    ...
    generateTestUser(app, isAdmin, function(err, user) {
        ...
        return generateTestUsers(app, total - 1, isAdmin, callback, _createdUsers);
    });
};
