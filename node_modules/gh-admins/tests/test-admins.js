...
var ADMIN_ID_NONEXISTENT = 234243423;
...
describe('Admins', function() {
    ...
    describe('Changing a global admin\'s password', function() {

        /**
         * Test that verifies that a global administrator's password can be updated
         */
        ...
        /**
         * Test that verifies validation when changing a global administrator's password
         */
        ...
        /**
         * Test that verifies authorization when changing a global administrator's password
         */
        it('verify authorization when changing a global administrator\'s password', function(callback) {
            ...
            AdminsTestsUtil.assertCreateGlobalAdmin(globalAdminClient, username, 'password', 'display name', function(createdGlobalAdmin, createdGlobalAdminClient) {
                ...
                // Anonymous users can't change other global administrators their password
