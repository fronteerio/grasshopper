...
describe('Config', function() {
     ...
     *
     * @param  {Client}     globalAdminClient   A global admin client that can create the tenant and application
     * @param  {Function}   callback            Standard callback function
     * @param  {Tenant}     callback.tenant     The created tenant
     * @param  {App}        callback.app        The created application
     */
    var createTestApp = function(globalAdminClient, callback) {
        var displayName = TestsUtil.generateString();
        var host = TestsUtil.generateString().toLowerCase() + '.grasshopper.com';

        TenantsTestUtil.assertCreateTenant(globalAdminClient, displayName, function(tenant) {

            AppsTestUtil.assertCreateApp(globalAdminClient, tenant.id, displayName, host, 'timetable', function(app) {

                return callback(tenant, app);
            });
        });
    };
    ...
    it('verify a config is automatically created when a new application is created', function(callback) {
        TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
            ...
            createTestApp(globalAdminClient, function(tenant, app) {
