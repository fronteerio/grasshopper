 ...
 */
GrassHopper.appServer.on('get', '/api/config', getConfig = function(req, res) {
    res.send(501);
});
 ...
 */
GrassHopper.globalAdminServer.on('get', '/api/config', function(req, res) {
    res.send(501);
});
 ...
 * @Return      {void}
 */
GrassHopper.appServer.on('post', '/api/config', function(req, res) {
    res.send(501);
});
 ...
 * @Return      {void}
 */
GrassHopper.globalAdminServer.on('post', '/api/config', function(req, res) {
    res.send(501);
});
 ...
 * @Return      {void}
 */
GrassHopper.appServer.on('post', '/api/config/clear', function(req, res) {
    res.send(501);
});
 ...
 * @Return      {void}
 */
GrassHopper.globalAdminServer.on('post', '/api/config/clear', function(req, res) {
    res.send(501);
});
