...
GrassHopper.globalAdminRouter.on('get', '/api/config', getConfig);
 ...
 * @Method      POST
 * @Path        /config
 * @FormParam   {number}            app             The id of the app to update the configuration value(s) for
 * @BodyParam   {ConfigValues}      body            Configuration value(s) to update
 * @Return      {void}
 */
...
GrassHopper.globalAdminRouter.on('post', '/api/config', updateConfig);
