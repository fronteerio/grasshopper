...
// The paths that shouldn't be protected by CSRF validation
var safePathPrefixes = ['/api/auth/shibboleth'];
...
var setUpServer = module.exports.setUpServer = function(port, config) {
    ...
    app.use(function(req, res, next) {
        ...
        res.on('finish', function() {
            // Only track requests for which we have explicitly defined a route
