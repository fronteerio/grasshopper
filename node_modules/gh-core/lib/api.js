...
var init = module.exports.init = function(config, callback) {
    ...
    DB.init(config, function(err) {
        ...
        DB.Tenant.findOrCreate({'where': {'id': 1}, 'defaults': {'displayName': 'Global admin tenant'}}).complete(function(err, tenant, created) {
            if (err) {
            ...
            DB.App.findOrCreate({'where': {'id': 1}, 'defaults': appOpts}).complete(function(err, app, created) {
                if (err) {
                ...
                module.exports.globalAdminServer = Server.setUpServer(2000, config);
                module.exports.appServer = Server.setUpServer(2001, config);
