...
var _setUpModel = function(sequelize) {
     ...
     * @property  {String}      visibility          A label that identifies the visibility status of the organisational unit. One of `draft` or `published`
     * @property  {Object}      metadata            An object with extra metadate for the organisational unit
     */
