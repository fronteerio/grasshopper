...
var _setUpModel = function(sequelize) {
     ...
     * @property {String}       displayName         The name of the app (e.g. `Timetable 2013-14`)
     * @property {Boolean}      enabled             Whether the app is currently enabled
     * @property {String}       host                The host on which the app can be found
     * @property {String}       type                The type of the app
     * @property {Tenant}       tenant              The tenant associated to the app
     */
     ...
     * @property {String}       authenticationStrategy      The authentication strategy with which the user connects to the system. Options are `local` or `shibboleth`
     * @property {String}       [username]                  The username with which the user logs in. This should be unique within the tenant. Can be `null` if `shibbolethId` is specified
     * @property {String}       [shibbolethId]              The Shibboleth entity id of the user. Can be `null` if `username` is specified
     ...
     * @property {String}       emailPreference             The email preference of the user. Options are `immediate` or `no`. The default is `immediate`
     * @property {Tenant}       tenant                      The tenant with which the user is associated
     * @property {Group[]}      memberships                 The groups the user is a member of
     * @property {App[]}        adminApps                   The applications the user can administer
     * @property {Event[]}      organizedEvents             The events the user has or will be organizing
     *
    ...
    },
    {
        ...
        'classMethods': {
            /**
             * Hash a given string so that it can be stored
             *
             * @param  {String}     str     The string to hash so that it can be stored
        ...
        'instanceMethods': {
            /**
             * Check whether a given string matches a stored password
             *
             * @param  {String}     str     The string to check
             * @return {Boolean}            `true` if the given string matches the stored password, `false` otherwise
             *
    ...
    User.hasMany(App, {'as': 'AdminApps', 'through': 'App_Admins'});
    App.hasMany(User, {'as': 'Admins', 'through': 'App_Admins'});
