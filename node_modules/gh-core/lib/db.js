...
var _setUpModel = function(sequelize) {
     ...
     * @param  {String}       isAdmin                 Whether the user is an app administrator
     ...
     * @param  {Date}         termsAndConditions      The timestamp (ISO 8601) at which the user accepted the Terms and Conditions
     */
    var User = module.exports.User = sequelize.define('User', {
        ...
        'instanceMethods': {
            ...
            'toJSON': function() {
                ...
                delete this.dataValues.Event_Organisers;
                delete this.dataValues.Group_Members;
    ...
    var Event = module.exports.Event = sequelize.define('Event', {
        ...
        'organiserOther': {
            ...
            'set': function(val) {
                if (val && _.isArray(val)) {
                    this.setDataValue('organiserOther', val.join(','));
                } else {
                    log().warn({'val': val, 'id': id}, 'Trying to set the organiserOther field with a value that is not an array');
        ...
        'instanceMethods': {
            'toJSON': function() {
                ...
                this.dataValues.organisers = others.concat(users);

                // Don't return the separate organiser lists
                delete this.dataValues.organiserOther;
                delete this.dataValues.Organisers;

                // Don't return unnecesary data
                delete this.dataValues.EventsSeries;
