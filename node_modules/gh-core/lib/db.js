...
var _setUpModel = function(sequelize) {
    ...
    var Serie = module.exports.Serie = sequelize.define('Serie', {
        ...
        'instanceMethods': {
            'toJSON': function() {
                // Don't return unnecessary data
                delete this.dataValues.OrgUnitsSeries;
     ...
     * @property {String}       shibMapLocale                       The attibute(s) that should be used to construct the locale. This should be a prioritised space seperated list
