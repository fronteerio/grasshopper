...
var log = require('./logger').logger('gh-core/signature');
var GrasshopperUtil = require('./util');

var signKey = null;

var TIME_12_HOURS_IN_SECONDS = 12 * 60 * 60;
...
var sign = module.exports.sign = function(data) {
    ...
    var orderedKeys = _.keys(data).sort();
 ...
 */
var verify = module.exports.verify = function(data, signature) {
 ...
 */
var createExpiringSignature = module.exports.createExpiringSignature = function(data, duration, offset) {
    ...
    var expires = new Date(start + duration + offset).getTime();
    var signature = sign(_createExpiringData(data, expires));
 ...
 */
var verifyExpiringSignature = module.exports.verifyExpiringSignature = function(data, expires, signature) {
 ...
 * @api private
 */
var _createExpiringData = function(data, expires) {
