...
var sendError = module.exports.sendError = function(res, err) {
    res.status(err.code).send(err.msg);
};

var createResponseCallback = module.exports.createResponseCallback = function(res, successCode) {
    ...
    return function(err, response) {
        ...
        return res.status(successCode).send(response);
    };
};
...
var toArray = module.exports.toArray = function(val) {
    ...
    if (_.isNumber(val) || _.isString(val) || _.isDate(val) || _.isObject(val.dataValues)) {
        return [val];
    }
