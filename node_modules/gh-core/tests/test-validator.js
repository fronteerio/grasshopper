...
describe('Validator', function() {
     ...
     *
     * @param  {App}                app                     The application for which to create the users
    ...
    it('verify isGlobalAdmin validation', function(callback) {
        createUsers(global.tests.apps.cam2013, function(user1, user2, user3, globalAdminUser) {
            ...
            assert.strictEqual(errors[0], 'An invalid context has been passed in');
            assert.strictEqual(errors[1], 'An invalid context has been passed in');
            assert.strictEqual(errors[2], 'The user is not logged in');
            assert.strictEqual(errors[3], 'The user is not logged in');
            assert.strictEqual(errors[4], 'The user is not a global administrator');
            assert.strictEqual(errors[5], 'The user is not a global administrator');
            assert.strictEqual(errors[6], 'The user is not logged in');
