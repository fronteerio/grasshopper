...
describe('Series', function() {
    ...
    describe('Subscribing', function() {
        ...
        it('verify a user can subscribe to a serie', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 2, false, function(serieCreator, serieSubscriber) {
                ...
                SeriesTestUtil.generateSerieWithEvents(serieCreator.client, 1, 10, calendarStart, calendarEnd, function(series) {
                    ...
                    SeriesTestUtil.assertSubscribeSeries(serieSubscriber.client, serie.id, serieSubscriber.profile.id, null, function() {
                        return callback();
                    });
                });
            });
        ...
        it('verify validation when a user subscribes to a serie', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', {}, function(serie) {
                    ...
                    // Invalid serie id
                    SeriesTestUtil.assertSubscribeSeriesFails(simon.client, 'Not a number', simon.profile.id, null, 400, function() {

                        // Unknown serie id
                        SeriesTestUtil.assertSubscribeSeriesFails(simon.client, -1, simon.profile.id, null, 404, function() {
                            SeriesTestUtil.assertSubscribeSeriesFails(simon.client, 234234234234, simon.profile.id, null, 404, function() {

                                // Invalid user id
                                SeriesTestUtil.assertSubscribeSeriesFails(simon.client, serie.id, 'Not a number', null, 400, function() {

                                    // Unknown user id
                                    SeriesTestUtil.assertSubscribeSeriesFails(simon.client, serie.id, -1, null, 404, function() {
                                        SeriesTestUtil.assertSubscribeSeriesFails(simon.client, serie.id, 234242423423, null, 404, function() {

                                            // Invalid context (orgunit) id
                                            SeriesTestUtil.assertSubscribeSeriesFails(simon.client, serie.id, simon.profile.id, 'Not a number', 400, function() {

                                                // Unknown context (orgunit) id
                                                SeriesTestUtil.assertSubscribeSeriesFails(simon.client, serie.id, simon.profile.id, -1, 404, function() {
                                                    SeriesTestUtil.assertSubscribeSeriesFails(simon.client, serie.id, simon.profile.id, 342234234, 404, function() {
                                                        return callback();
                                                    });
                                                });
                                            });
                        ...
                        OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.oxford2014.client, 'Orgunit', 'course', null, function(oxfordOrgUnit) {
                            ...
                            SeriesTestUtil.generateSerieWithEvents(camUser.client, 3, 10, calendarStart, calendarEnd, function(series) {
                                ...
                                TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                                    SeriesTestUtil.assertSubscribeSeriesFails(anonymousClient, serie.id, camUser.profile.id, null, 401, function() {

                                        // Users cannot subscribe to a serie with a context to which the serie does not belong
                                        SeriesTestUtil.assertSubscribeSeriesFails(camUser.client, serie.id, camUser.profile.id, camOrgUnit.id, 400, function() {

                                            // Users cannot subscribe to a serie from another app
                                            SeriesTestUtil.assertSubscribeSeriesFails(oxfordUser.client, serie.id, oxfordUser.profile.id, null, 401, function() {

                                                // Users cannot subscribe to a serie from their own app with an organisational unit from another
                                                SeriesTestUtil.assertSubscribeSeriesFails(camUser.client, serie.id, camUser.profile.id, oxfordOrgUnit.id, 401, function() {

                                                    // Users cannot subscribe other users
                                                    SeriesTestUtil.assertSubscribeSeriesFails(camUser.client, serie.id, anotherCamUser.profile.id, null, 401, function() {
                                                        SeriesTestUtil.assertSubscribeSeriesFails(camUser.client, serie.id, oxfordUser.profile.id, null, 401, function() {

                                                            // App admins can subscribe users
                                                            SeriesTestUtil.assertSubscribeSeries(global.tests.admins.cam2013.client, series[1].id, camUser.profile.id, null, function() {

                                                                // App admins cannot subscribe users from other applications
                                                                SeriesTestUtil.assertSubscribeSeriesFails(global.tests.admins.cam2013.client, series[1].id, oxfordUser.profile.id, null, 401, function() {

                                                                    // Global admins can subscribe users
                                                                    TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                                                                        SeriesTestUtil.assertSubscribeSeries(globalAdminClient, series[2].id, camUser.profile.id, null, function() {
                                                                            return callback();
                                                                        });
                                                                    });
                                                                });
        ...
        it('verify the user is defaulted to the current user when subscribing to a serie', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 2, false, function(serieCreator, serieSubscriber) {
                ...
                SeriesTestUtil.generateSerieWithEvents(serieCreator.client, 1, 10, calendarStart, calendarEnd, function(series) {
                    ...
                    SeriesTestUtil.assertSubscribeSeries(serieSubscriber.client, serie.id, null, null, function() {
                        return callback();
                    });
                });
            });
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Orgunit 1', 'course', null, function(orgUnit1) {
                    OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Orgunit 2', 'course', null, function(orgUnit2) {
                        var calendarStart = moment().subtract(1, 'day').format();
                        var calendarEnd = moment().add(30, 'day').format();
                        SeriesTestUtil.generateSerieWithEvents(global.tests.admins.cam2013.client, 1, 5, calendarStart, calendarEnd, function(series) {
                            var serie = series[0];
                            OrgUnitTestsUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, orgUnit1.id, [serie.id], null, function() {
                                OrgUnitTestsUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, orgUnit2.id, [serie.id], null, function() {

                                    // Subscribe to the serie and specify we did it in the context
                                    // of the first organisational unit
                                    SeriesTestUtil.assertSubscribeSeries(simon.client, serie.id, simon.profile.id, orgUnit1.id, function() {
        ...
        /**
         * Test that verifies that contexts are retained even when a serie is removed from an organisational unit
         */
        it('verify contexts are retained even when a serie is removed from an organisational unit', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {

                // Generate an organisational unit and add a serie to it
                OrgUnitTestsUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, 'Orgunit', 'course', null, function(orgUnit) {
                    var calendarStart = moment().subtract(1, 'day').format();
                    var calendarEnd = moment().add(30, 'day').format();
                    SeriesTestUtil.generateSerieWithEvents(global.tests.admins.cam2013.client, 1, 5, calendarStart, calendarEnd, function(series) {
                        var serie = series[0];
                        OrgUnitTestsUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, orgUnit.id, [serie.id], null, function() {

                            // Subscribe to the serie and specify the organisational unit as context
                            SeriesTestUtil.assertSubscribeSeries(simon.client, serie.id, simon.profile.id, orgUnit.id, function() {
                                ...
                                UsersTestsUtil.assertGetUserCalendar(simon.client, simon.profile.id, calendarStart, calendarEnd, null, function(calendar) {
                                    ...
                                    _.each(calendar.results, function(event) {
                                        assert.ok(event.context);
                                        assert.strictEqual(event.context.id, orgUnit.id);
                                    });

                                    // Remove the serie from the organisational unit
                                    OrgUnitTestsUtil.assertDeleteOrgUnitSeries(global.tests.admins.cam2013.client, orgUnit.id, [serie.id], function() {

                                        // Verify the context still returns when retrieving the user calendar
                                        UsersTestsUtil.assertGetUserCalendar(simon.client, simon.profile.id, calendarStart, calendarEnd, null, function(calendar) {
                                            assert.strictEqual(calendar.results.length, 5);
                                            _.each(calendar.results, function(event) {
                                                assert.ok(event.context);
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 2, false, function(camUser, anotherCamUser) {
                TestsUtil.generateTestUsers(global.tests.apps.oxford2014, 1, false, function(oxfordUser) {
                    ...
                    SeriesTestUtil.generateSerieWithEvents(camUser.client, 3, 10, calendarStart, calendarEnd, function(series) {
                        ...
                        SeriesTestUtil.assertSubscribeSeries(camUser.client, series[0].id, camUser.profile.id, null, function() {
                            SeriesTestUtil.assertSubscribeSeries(camUser.client, series[1].id, camUser.profile.id, null, function() {
                                SeriesTestUtil.assertSubscribeSeries(camUser.client, series[2].id, camUser.profile.id, null, function() {
                                    ...
                                    TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                                        SeriesTestUtil.assertUnsubscribeSeriesFails(anonymousClient, series[0].id, camUser.profile.id, 401, function() {
                                            ...
                                            SeriesTestUtil.assertSubscribeSeriesFails(anotherCamUser.client, series[0].id, camUser.profile.id, null, 401, function() {

                                                // Users cannot unsubscribe other users from other applications
                                                SeriesTestUtil.assertSubscribeSeriesFails(oxfordUser.client, series[0].id, camUser.profile.id, null, 401, function() {
