 ...
 * @throws {AssertionError}                                     Error thrown when an assertion failed
 */
var assertSubscribeSeries = module.exports.assertSubscribeSeries = function(client, id, userId, callback) {
    client.serie.subscribeSeries(id, userId, function(err) {
        assert.ok(!err);
 ...
 * @throws {AssertionError}                                     Error thrown when an assertion failed
 */
var assertSubscribeSeriesFails = module.exports.assertSubscribeSeriesFails = function(client, id, userId, code, callback) {
    client.serie.subscribeSeries(id, userId, function(err) {
        assert.ok(err);
        assert.strictEqual(err.code, code);
        return callback();
