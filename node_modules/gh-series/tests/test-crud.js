    ...
    describe('Getting a serie', function() {
        ...
        it('verify getting a serie', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(createdSerie) {
                    ...
                    SeriesTestUtil.assertGetSeries(simon.client, createdSerie.id, false, true, createdSerie, function(serie) {
        ...
        it('verify validation when getting a serie', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                // Invalid serie id
                SeriesTestUtil.assertGetSeriesFails(simon.client, 'not a number', false, 400, function() {

                    // Unknown serie id
                    SeriesTestUtil.assertGetSeriesFails(simon.client, -1, false, 404, function() {

                        // Invalid include orgunit boolean flag
                        SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(createdSerie) {
                            SeriesTestUtil.assertGetSeriesFails(simon.client, createdSerie.id, 'not a boolean', 400, function() {
                                return callback();
                            });
                        });
                    });
        ...
        it('verify authorization when getting a series', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 2, false, function(simon, sam) {
                TestsUtil.generateTestUsers(global.tests.apps.cam2014, 1, false, function(nico) {
                    ...
                    SeriesTestUtil.assertCreateSerie(simon.client, 'Test series', null, function(createdSeries) {

                        // Assert that it can't be retrieved on the 2014 app
                        SeriesTestUtil.assertGetSeriesFails(nico.client, createdSeries.id, false, 401, function() {

                            // Assert a global admin can retrieve it
                            TestsUtil.getGlobalAdminRestClient(function(adminClient) {
                                SeriesTestUtil.assertGetSeries(adminClient, createdSeries.id, false, true, createdSeries, function(series) {

                                    // Simon created the series so he can manage it
                                    SeriesTestUtil.assertGetSeries(simon.client, createdSeries.id, false, true, createdSeries, function(series) {

                                        // Sam can't manage the series
                                        SeriesTestUtil.assertGetSeries(sam.client, createdSeries.id, false, false, createdSeries, function(series) {

                                            // Anonymous users can't manage the series
                                            TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                                                SeriesTestUtil.assertGetSeries(anonymousClient, createdSeries.id, false, false, createdSeries, function(series) {
        ...
        it('verify organisational units can be retrieved when getting a serie', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(createdSerie) {
                    ...
                    SeriesTestUtil.assertGetSeries(simon.client, createdSerie.id, true, true, createdSerie, function(serie) {
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, '#1', 'course', null, function(orgUnit1) {
                    OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, '#2', 'course', null, function(orgUnit2) {
                        ...
                        SeriesTestUtil.assertCreateSerie(simon.client, 'Test series', null, function(series) {
                            OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, orgUnit1.id, [series.id], function() {
                                ...
                                SeriesTestUtil.assertGetSeries(simon.client, series.id, true, true, null, function(series) {
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(createdSerie) {
                    SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(otherSerie) {
                        ...
                        SeriesTestUtil.assertUpdateSerie(simon.client, createdSerie.id, update, function(updatedSerie) {
                            ...
                            // Retrieve it
                            SeriesTestUtil.assertGetSeries(simon.client, createdSerie.id, false, true, updatedSerie, function(retrievedSerie) {
                                return callback();
                            });
                        });
                    });
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(createdSerie) {
                    ...
                    SeriesTestUtil.assertDeleteSerie(simon.client, createdSerie.id, function() {
                        ...
                        SeriesTestUtil.assertGetSeriesFails(simon.client, createdSerie.id, false, 404, callback);
                    });
                });
            });
        });
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                    ...
                    SeriesTestUtil.assertDeleteSerieFails(simon.client, 'not a number', 400, function() {
                        ...
                        SeriesTestUtil.assertDeleteSerieFails(simon.client, 'not a number', 400, function() {
                            ...
                            SeriesTestUtil.assertGetSeries(simon.client, serie.id, false, true, serie, function(serie) {
                                return callback();
                            });
                        });
                    });
