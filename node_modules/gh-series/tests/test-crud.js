...
describe('Series', function() {
    ...
    describe('Getting a serie', function() {
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 2, false, function(simon, sam) {
                TestsUtil.generateTestUsers(global.tests.apps.cam2014, 1, false, function(nico) {
                    ...
                    SeriesTestUtil.assertCreateSerie(simon.client, 'Test series', null, function(createdSeries) {
                        ...
                        SeriesTestUtil.assertGetSerieFails(nico.client, createdSeries.id, false, 401, function() {

                            // Assert a global admin can retrieve it
                            TestsUtil.getGlobalAdminRestClient(function(adminClient) {
                                SeriesTestUtil.assertGetSerie(adminClient, createdSeries.id, false, createdSeries, function(series) {
                                    assert.strictEqual(series.canManage, true);

                                    // Simon created the series so he can manage it
                                    SeriesTestUtil.assertGetSerie(simon.client, createdSeries.id, false, createdSeries, function(series) {
                                        assert.strictEqual(series.canManage, true);

                                        // Sam can't manage the series
                                        SeriesTestUtil.assertGetSerie(sam.client, createdSeries.id, false, createdSeries, function(series) {
                                            assert.strictEqual(series.canManage, false);

                                            // Anonymous users can't manage the series
                                            TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                                                SeriesTestUtil.assertGetSerie(anonymousClient, createdSeries.id, false, createdSeries, function(series) {
                                                    assert.strictEqual(series.canManage, false);
        ...
        /**
         * Test that verifies that the organisational unit a series is borrowed from is indicated when getting a series and including the organisational units
         */
        it('verify the organisational unit a series is borrowed from is indicated when getting a series and including the organisational units', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                    ...
                    OrgUnitTestUtil.assertCreateOrgUnit(global.tests.admins.cam2013.client, '#2', 'course', null, function(orgUnit2) {
                        ...
                        SeriesTestUtil.assertCreateSerie(simon.client, 'Test series', null, function(series) {
                            OrgUnitTestUtil.assertAddOrgUnitSeries(global.tests.admins.cam2013.client, orgUnit1.id, [series.id], function() {
                                ...
                                SeriesTestUtil.assertGetSerie(simon.client, series.id, true, null, function(series) {
