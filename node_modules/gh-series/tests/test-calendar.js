        ...
        it('verify validation when retrieving a series calendar as JSON', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                    ...
                    SeriesTestUtil.assertCreateSerie(global.tests.admins.oxford2014.client, 'Test serie', null, function(oxfordSerie) {

                        var calendarStart = moment().subtract(1, 'day').format();
                        var calendarEnd = moment().add(30, 'day').format();

                        // Invalid serie id
                        SeriesTestUtil.assertGetSeriesCalendarFails(simon.client, 'Not a number', calendarStart, calendarEnd, 400, function() {

                            // Unknown serie id
                            SeriesTestUtil.assertGetSeriesCalendarFails(simon.client, -1, calendarStart, calendarEnd, 404, function() {
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                    ...
                    SeriesTestUtil.assertCreateSerie(global.tests.admins.oxford2014.client, 'Test serie', null, function(oxfordSerie) {
                        ...
                        // Invalid serie id
                        SeriesTestUtil.assertGetSeriesCalendarRssFails(simon.client, 'Not a number', calendarStart, calendarEnd, 400, function() {

                            // Unknown serie id
                            SeriesTestUtil.assertGetSeriesCalendarRssFails(simon.client, -1, calendarStart, calendarEnd, 404, function() {

                                // A serie from another application
                                SeriesTestUtil.assertGetSeriesCalendarRssFails(simon.client, oxfordSerie.id, calendarStart, calendarEnd, 401, function() {
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                    ...
                    SeriesTestUtil.assertCreateSerie(global.tests.admins.oxford2014.client, 'Test serie', null, function(oxfordSerie) {
                        ...
                        // Invalid serie id
                        SeriesTestUtil.assertGetSeriesCalendarIcalFails(simon.client, 'Not a number', null, null, 400, function() {

                            // Unknown serie id
                            SeriesTestUtil.assertGetSeriesCalendarIcalFails(simon.client, -1, null, null, 404, function() {

                                // A serie from another application
                                SeriesTestUtil.assertGetSeriesCalendarIcalFails(simon.client, oxfordSerie.id, null, null, 401, function() {
