            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                EventsTestUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(event) {
                    ...
                    SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                        ...
                        SeriesTestUtil.assertAddSeriesEvents(simon.client, serie.id, [event.id], function() {

                            // Verify the event has been added
                            SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, null, null, [event], function(events) {
                                return callback();
                            });
                        });
                    });
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                EventsTestUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(event) {
                    ...
                    SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                        ...
                        // Invalid serie id
                        SeriesTestUtil.assertAddSeriesEventsFails(simon.client, 'not a number', [event.id], 400, function() {

                            // Unknown serie id
                            SeriesTestUtil.assertAddSeriesEventsFails(simon.client, -1, [event.id], 404, function() {

                                // Invalid event id
                                SeriesTestUtil.assertAddSeriesEventsFails(simon.client, serie.id, ['not a number'], 400, function() {

                                    // Unknown event id
                                    SeriesTestUtil.assertAddSeriesEventsFails(simon.client, serie.id, [-1], 404, function() {

                                        // Invalid event id
                                        SeriesTestUtil.assertAddSeriesEventsFails(simon.client, serie.id, [event.id, 'not a number'], 400, function() {

                                            // Unknown event id
                                            SeriesTestUtil.assertAddSeriesEventsFails(simon.client, serie.id, [event.id, -1], 404, function() {

                                                // Sanity-check no events have been added
                                                SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, null, null, [], function(events) {
                                                    return callback();
                                                });
                                            });
                                        });
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                    ...
                    EventsTestUtil.generateTestEvents(simon.client, 3, calendarStart, calendarEnd, function(events) {
                        ...
                        TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                            SeriesTestUtil.assertAddSeriesEventsFails(anonymousClient, serie.id, eventIds, 401, function() {

                                // Users who are not part of the serie's group cannot add events to it
                                SeriesTestUtil.assertAddSeriesEventsFails(nico.client, serie.id, eventIds, 401, function() {

                                    // Application admins from another application cannot add events to a serie
                                    SeriesTestUtil.assertAddSeriesEventsFails(global.tests.admins.cam2014.client, serie.id, eventIds, 401, function() {
                                        ...
                                        GroupsTestUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, serie.GroupId, memberUpdate, function() {
                                            SeriesTestUtil.assertAddSeriesEvents(nico.client, serie.id, events[0].id, function() {

                                                // Application admins can add series events
                                                SeriesTestUtil.assertAddSeriesEvents(global.tests.admins.cam2013.client, serie.id, events[1].id, function() {

                                                    // Verify both events were added
                                                    SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, null, null, [events[0], events[1]], function(events) {
                                                        return callback();
                                                    });
                                                });
                                            });
            ...
            EventsTestUtil.generateTestEvents(global.tests.admins.cam2013.client, 3, calendarStart, calendarEnd, function(camEvents) {
                ...
                EventsTestUtil.generateTestEvents(global.tests.admins.oxford2013.client, 3, calendarStart, calendarEnd, function(oxfordEvents) {
                    ...
                    SeriesTestUtil.assertCreateSerie(global.tests.admins.cam2013.client, 'Test serie', null, function(serie) {
                        ...
                        SeriesTestUtil.assertAddSeriesEventsFails(global.tests.admins.cam2013.client, serie.id, oxfordEventIds, 400, function() {

                            // Sanity check the cambridge events can be added to the cambridge serie
                            SeriesTestUtil.assertAddSeriesEvents(global.tests.admins.cam2013.client, serie.id, camEventIds, function() {
                                return callback();
                            });
                        });
                    });
                    ...
                    SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                        ...
                        SeriesTestUtil.assertAddSeriesEvents(simon.client, serie.id, [event.id], function() {
                            ...
                            SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, null, null, [event], function(events) {
                                ...
                                SeriesTestUtil.assertDeleteSeriesEvents(simon.client, serie.id, [event.id], function() {
                ...
                EventsTestUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(event) {
                    ...
                    SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                        ...
                        SeriesTestUtil.assertAddSeriesEvents(simon.client, serie.id, [event.id], function() {
                            ...
                            // Invalid serie id
                            SeriesTestUtil.assertDeleteSeriesEventsFails(simon.client, 'not a number', [event.id], 400, function() {

                                // Unknown serie id
                                SeriesTestUtil.assertDeleteSeriesEventsFails(simon.client, -1, [event.id], 404, function() {

                                    // Invalid event id
                                    SeriesTestUtil.assertDeleteSeriesEventsFails(simon.client, serie.id, ['not a number'], 400, function() {

                                        // Unknown event id
                                        SeriesTestUtil.assertDeleteSeriesEventsFails(simon.client, serie.id, [-1], 400, function() {

                                            // Invalid event id
                                            SeriesTestUtil.assertDeleteSeriesEventsFails(simon.client, serie.id, [event.id, 'not a number'], 400, function() {

                                                // Unknown event id
                                                SeriesTestUtil.assertDeleteSeriesEventsFails(simon.client, serie.id, [event.id, -1], 400, function() {
                                                    ...
                                                    EventsTestUtil.assertCreateEvent(simon.client, 'Test event', start, end, null, function(otherEvent) {
                                                        SeriesTestUtil.assertDeleteSeriesEventsFails(simon.client, serie.id, [otherEvent.id], 400, function() {
            ...
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 2, false, function(simon, nico) {
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                    ...
                    EventsTestUtil.generateTestEvents(simon.client, 3, calendarStart, calendarEnd, function(events) {
                        ...
                        SeriesTestUtil.assertAddSeriesEvents(simon.client, serie.id, eventIds, function() {

                            // Anonymous users cannot remove events from a serie
                            TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                                SeriesTestUtil.assertDeleteSeriesEventsFails(anonymousClient, serie.id, eventIds, 401, function() {

                                    // Users who are not part of the serie's group cannot remove events from a serie
                                    SeriesTestUtil.assertDeleteSeriesEventsFails(nico.client, serie.id, eventIds, 401, function() {

                                        // Application admins from another application cannot remove events from a serie
                                        SeriesTestUtil.assertDeleteSeriesEventsFails(global.tests.admins.cam2014.client, serie.id, eventIds, 401, function() {

                                            // Users who are members of the serie's group can remove events from a serie
                                            var memberUpdate = {};
                                            memberUpdate[nico.profile.id] = true;
                                            GroupsTestUtil.assertUpdateGroupMembers(global.tests.admins.cam2013.client, serie.GroupId, memberUpdate, function() {
                                                SeriesTestUtil.assertDeleteSeriesEvents(nico.client, serie.id, events[0].id, function() {

                                                    // Application admins can remove events from a serie
                                                    SeriesTestUtil.assertDeleteSeriesEvents(global.tests.admins.cam2013.client, serie.id, events[1].id, function() {

                                                        // Verify both events were removed and only one event is left
                                                        SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, null, null, [events[2]], function(events) {
                                                            return callback();
                                                        });
                                                    });
                                                });
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                    ...
                    EventsTestUtil.generateTestEvents(simon.client, 3, calendarStart, calendarEnd, function(events) {
                        ...
                        SeriesTestUtil.assertAddSeriesEvents(simon.client, serie.id, eventIds, function() {
                            ...
                            SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, null, null, events, function(events) {
                                return callback();
                            });
                        });
                    });
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                    ...
                    EventsTestUtil.generateTestEvents(simon.client, 3, calendarStart, calendarEnd, function(events) {
                        ...
                        SeriesTestUtil.assertAddSeriesEvents(simon.client, serie.id, eventIds, function() {
                            ...
                            // Invalid serie id
                            SeriesTestUtil.assertGetSeriesEventsFails(simon.client, 'not a number', null, null, null, 400, function() {

                                // Unknown serie
                                SeriesTestUtil.assertGetSeriesEventsFails(simon.client, -1, null, null, null, 404, function() {
                                    return callback();
                                });
                            });
                        });
                    ...
                    SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                        ...
                        EventsTestUtil.generateTestEvents(simon.client, 3, calendarStart, calendarEnd, function(events) {
                            ...
                            SeriesTestUtil.assertAddSeriesEvents(simon.client, serie.id, eventIds, function() {
                                ...
                                SeriesTestUtil.assertGetSeriesEventsFails(nico.client, serie.id, null, null, null, 401, function() {
                                    return callback();
                                });
                            });
                        });
                ...
                SeriesTestUtil.assertCreateSerie(simon.client, 'Test serie', null, function(serie) {
                    ...
                    EventsTestUtil.generateTestEvents(simon.client, 30, calendarStart, calendarEnd, function(events) {
                        ...
                        SeriesTestUtil.assertAddSeriesEvents(simon.client, serie.id, eventIds, function() {
                            ...
                            SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, null, null, null, function(firstPage) {
                                // Verify the first 10 events are returned
                                assert.strictEqual(firstPage.results.length, 10);

                                // Get the next 10 events
                                SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, 10, null, null, function(secondPage) {
                                    ...
                                    // Get the last 10
                                    SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, 20, null, null, function(thirdPage) {
                                        // Verify 10 events are returned
                                        ...
                                        SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, null, 30, null, null, function(thirdPage) {
                                            assert.strictEqual(thirdPage.results.length, 0);

                                            // Verify the limit parameter
                                            SeriesTestUtil.assertGetSeriesEvents(simon.client, serie.id, 5, 0, null, null, function(page) {
