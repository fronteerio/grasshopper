 ...
 * Create a series
 *
 * @param  {Number}         appId                       The id of the application that this series will belong to
 * @param  {String}         displayName                 The name of the series
 * @param  {String}         [description]               The description of the series
 * @param  {Number}         group                       The id of the group that can manage the series
 * @param  {String}         [externalId]                The external id of the series
 * @param  {Object}         [metadata]                  The metadata of the series
 * @param  {Function}       callback                    Standard callback function
 * @param  {Object}         callback.err                An error object, if any
 * @param  {Serie}          callback.series             The created series
 */
var createSeries = module.exports.createSeries = function(appId, displayName, description, group, externalId, metadata, callback) {
    var series = {
        'AppId': appId,
    ...
    DB.Serie.create(series).complete(function(err, series) {
        if (err) {
            log().error({'err': err}, 'Failed to create a new series');
...
var getSerie = module.exports.getSerie = function(id, includeOrgUnits, callback) {
    ...
    DB.Serie.findOne(options).complete(function(err, serie) {
        if (err) {
        ...
        if (includeOrgUnits) {
            ...
            if (!_.isEmpty(serie.OrgUnits) && serie.OrgUnits.length > 1) {
                serie.borrowedFrom = serie.OrgUnits[0];
            }
        }
