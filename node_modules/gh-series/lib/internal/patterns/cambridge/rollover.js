...
/**
 * Given a timestamp, get the term under which it falls. The term nearest the timestamp
 * is returned when timestamp does not fall under a term.
 *
 ...
 * @return {Moment}             The moment half way between the start and end date
 */
var dateInBetween = module.exports.dateInBetween = function(start, end) {
    return start.clone().add(Math.floor(end.diff(start, 'days') / 2), 'days');
};
