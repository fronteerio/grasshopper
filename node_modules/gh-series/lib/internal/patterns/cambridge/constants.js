...
/**
 * Convert a date string to a momentjs object. The timezone
 * for the date will be set to Europe/London
 *
 * @param  {String}     dateStr     The date string to convert
 * @return {Moment}                 The momentjs object for the given date
 * @api private
 */
var _termDateMoment = function(dateStr) {
    return moment.tz(dateStr, 'YYYY-MM-DD', 'Europe/London');
};
