 ...
 * @QueryParam  {boolean}           from                The timestamp (ISO 8601) from which to get the calendar for the event series
 * @QueryParam  {boolean}           to                  The timestamp (ISO 8601) until which to get the calendar for the event series
