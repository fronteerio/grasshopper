...
GrassHopper.globalAdminServer.on('get', '/api/series/:id', getSeries);
GrassHopper.appServer.on('get', '/api/series/:id', getSeries);
 ...
 * @QueryParam  {boolean}           [upcoming]          Whether to only include upcoming events. Defaults to `false`
...
GrassHopper.globalAdminServer.on('get', '/api/series/:id/events', getSeriesEvents);
GrassHopper.appServer.on('get', '/api/series/:id/events', getSeriesEvents);
 ...
 * @QueryParam  {boolean}           from                The timestamp (millis since epoch) from which to get the calendar for the event series
 * @QueryParam  {boolean}           to                  The timestamp (millis since epoch) until which to get the calendar for the event series
...
GrassHopper.globalAdminServer.on('get', '/api/series/:id/calendar', getSeriesCalendar);
GrassHopper.appServer.on('get', '/api/series/:id/calendar', getSeriesCalendar);
...
GrassHopper.globalAdminServer.on('get', '/api/series/:id/calendar.ical', getSeriesCalendarIcal);
GrassHopper.appServer.on('get', '/api/series/:id/calendar.ical', getSeriesCalendarIcal);
...
GrassHopper.globalAdminServer.on('get', '/api/series/:id/calendar.rss', getSeriesCalendarRss);
GrassHopper.appServer.on('get', '/api/series/:id/calendar.rss', getSeriesCalendarRss);
...
GrassHopper.globalAdminServer.on('get', '/api/series/:id/upcoming', getSeriesUpcoming);
GrassHopper.appServer.on('get', '/api/series/:id/upcoming', getSeriesUpcoming);
 ...
 */
GrassHopper.appServer.on('post', '/api/series', function(req, res) {
    res.send(501);
});
 ...
 * @Return      {Series}                                The created event series
 */
GrassHopper.globalAdminServer.on('post', '/api/series', function(req, res) {
    res.send(501);
});
...
GrassHopper.globalAdminServer.on('post', '/api/series/:id', updateSeries);
GrassHopper.appServer.on('post', '/api/series/:id', updateSeries);
...
GrassHopper.globalAdminServer.on('post', '/api/series/:id/picture', setSeriesPicture);
GrassHopper.appServer.on('post', '/api/series/:id/picture', setSeriesPicture);
...
GrassHopper.globalAdminServer.on('post', '/api/series/:id/picture/crop', cropSeriesPicture);
GrassHopper.appServer.on('post', '/api/series/:id/picture/crop', cropSeriesPicture);
 ...
 * @FormParam   {string[]}          event               The id of the event to add to the event series
 * @Return      {void}
 */
...
GrassHopper.globalAdminServer.on('post', '/api/series/:id/events', addSeriesEvents);
GrassHopper.appServer.on('post', '/api/series/:id/events', addSeriesEvents);
 ...
 * @FormParam   {string[]}          event               The id of the event to remove from the event series
 * @Return      {void}
 */
...
GrassHopper.globalAdminServer.on('delete', '/api/series/:id/events', deleteSeriesEvents);
GrassHopper.appServer.on('delete', '/api/series/:id/events', deleteSeriesEvents);
...
GrassHopper.globalAdminServer.on('delete', '/api/series/:id', deleteSeries);
GrassHopper.appServer.on('delete', '/api/series/:id', deleteSeries);
...
GrassHopper.globalAdminServer.on('post', '/api/series/:id/subscribers', getSeriesSubscribers);
GrassHopper.appServer.on('post', '/api/series/:id/subscribers', getSeriesSubscribers);

/**
 * @REST subscribeSeries
 *
 * Subscribe to the an event series
 *
 * @Server      admin,app
 * @Method      GET
...
GrassHopper.globalAdminServer.on('post', '/api/series/:id/subscribe', subscribeSeries);
GrassHopper.appServer.on('post', '/api/series/:id/subscribe', subscribeSeries);
