...
var getSeriesCalendarRss = function(req, res) {
    SeriesAPI.getSeriesCalendarAsRSS(req.ctx, req.params.id, req.query.from, req.query.to, function(err, calendar) {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
...
var createSeries = function(req, res) {
    SeriesAPI.createSerie(req.ctx, req.body.app, req.body.displayName, req.body.description, req.body.group, function(err, series) {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
