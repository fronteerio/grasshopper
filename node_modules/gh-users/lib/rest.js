 ...
 * @QueryParam  {number}            app                     The id of the app for which to get the upcoming events for the user
 * @QueryParam  {number}            [items]                 The maximum number of results to retrieve. Default: 10
 * @QueryParam  {number}            [page]                  The paging number of the results to retrieve
...
// TODO: Associate a user to an app
// TODO: Disassociate a user from an app
