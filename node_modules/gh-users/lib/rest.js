...
GrassHopper.globalAdminRouter.on('get', '/api/users/:id/calendar.ical', getUserCalendarIcal);
GrassHopper.appRouter.on('get', '/api/users/:id/calendar.ical', getUserCalendarIcal);
...
GrassHopper.globalAdminRouter.on('get', '/api/users/:id/calendar.rss', getUserCalendarRss);
GrassHopper.appRouter.on('get', '/api/users/:id/calendar.rss', getUserCalendarRss);
 ...
 * @FormParam   {number}            [appId]                 The id of the app to which the user should be added
