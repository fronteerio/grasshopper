 ...
 */
GrassHopper.appServer.on('get', '/api/me', function(req, res) {
...
GrassHopper.globalAdminServer.on('post', '/api/users/:id/app', addUserToApp);
GrassHopper.appServer.on('post', '/api/users/:id/app', addUserToApp);
...
GrassHopper.globalAdminServer.on('delete', '/api/users/:id/app', deleteUserFromApp);
GrassHopper.appServer.on('delete', '/api/users/:id/app', deleteUserFromApp);
