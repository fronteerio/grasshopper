 ...
 * @FormParam   {string}            [tenantId]              The id of the tenant to which the user should be added. This defaults to the tenant of the current app
...
GrassHopper.globalAdminRouter.on('post', '/api/users', createUser);
GrassHopper.appRouter.on('post', '/api/users', createUser);
