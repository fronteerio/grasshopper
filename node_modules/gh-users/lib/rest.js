 ...
 * @Method      GET
 * @Path        /users
 * @QueryParam  {string}            [q]                     The string to filter users by
...
var getUsers = function(req, res) {
    UsersAPI.getUsers(req.ctx, req.query.app, req.query.q, req.query.limit, req.query.offset, function(err, users) {
        if (err) {
