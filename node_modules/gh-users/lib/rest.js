...
GrassHopper.globalAdminRouter.on('post', '/api/users', function(req, res) {
    ...
    UsersAPI.createUser(req.ctx, req.body.appId, userProfile, credentials, function(err, user) {
        if (err) {
...
GrassHopper.appRouter.on('post', '/api/users', function(req, res) {
    ...
    UsersAPI.createUser(req.ctx, req.ctx.app.id, userProfile, credentials, function(err, user) {
        if (err) {
            return res.status(err.code).send(err.msg);
        }
