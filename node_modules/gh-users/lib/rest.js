 ...
 */
GrassHopper.globalAdminServer.get('/api/users', function(req, res) {
    res.send(501);
});
...
GrassHopper.globalAdminServer.get('/api/apps/:id/users', getAppUsers);
GrassHopper.tenantServer.get('/api/apps/:id/users', getAppUsers);
 ...
 */
GrassHopper.appServer.get('/api/users/:id', function(req, res) {
    res.send(501);
});
...
GrassHopper.appServer.get('/api/me', getMe);
 ...
 * @Method      POST
 * @Path        /users
 * @FormParam   {string}            authenticationStrategy  The authentication strategy with which the user will authenticate           [local,shibboleth]
 ...
 * @FormParam   {string[]}          [app]                   The apps to which the user should be added. Not required when the current user is a global administrator
 ...
 * @FormParam   {string}            [shibbolethId]          The unique shibboleth id for the user, prefixed with identity provider id. This is only required when using the shibboleth authentication strategy
...
GrassHopper.globalAdminServer.post('/api/users', createUser);
GrassHopper.appServer.post('/api/users', createUser);
