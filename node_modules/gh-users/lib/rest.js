...
var getUsers = function(req, res) {
    var app = req.query.app || req.ctx.app.id;
    UsersAPI.getUsers(req.ctx, app, req.query.q, req.query.limit, req.query.offset, function(err, users) {
        if (err) {
...
GrassHopper.globalAdminRouter.on('get', '/api/users', getUsers);
GrassHopper.appRouter.on('get', '/api/users', getUsers);
...
GrassHopper.appRouter.on('get', '/api/me', function(req, res) {
    ...
    if (req.ctx.user) {
        me = _.extend({'anon': false}, req.ctx.user.toJSON());
    }
 ...
 */
var resetUserCalendarToken = function(req, res) {
...
GrassHopper.globalAdminRouter.on('post', '/api/users/:id/token', resetUserCalendarToken);
GrassHopper.appRouter.on('post', '/api/users/:id/token', resetUserCalendarToken);
