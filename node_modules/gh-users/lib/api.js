...
var createUser = module.exports.createUser = function(ctx, appId, userProfile, credentials, callback) {
    ...
    var canNotAdminApp = (!ctx.user || !ctx.user.canAdmin(appId));
    if (userProfile.isAdmin && canNotAdminApp) {
    ...
    AppsAPI.getApp(ctx, appId, function(err, app) {
        ...
        if (credentials.strategy === 'local' && canNotAdminApp && !allowLocalAccountCreation) {
