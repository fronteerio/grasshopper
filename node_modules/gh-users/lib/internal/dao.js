...
var searchUsers = module.exports.searchUsers = function(appId, query, limit, offset, callback) {
    ...
    var coalescedValue = '';
    var parameters = [appId, query, coalescedValue, query, coalescedValue, query, limit, offset];
    sequelize.query(sqlQuery, DB.User, null, parameters).complete(function(err, users) {
        if (err) {
