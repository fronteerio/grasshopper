 ...
 */
var getUsers = module.exports.getUsers = function(appId, ids, callback) {
...
var getUserCalendar = module.exports.getUserCalendar = function(user, start, end, callback) {
    ...
    user.getCalendar(options).complete(function(err, calendar) {
        ...
        var orgUnitsToRetrieve = {};

        var events = calendar.Events;
        _.each(calendar.Series, function(serie) {
            // Add the originating organisational unit context to each event
            serie.Events = _.map(serie.Events, function(event) {
                event.context = serie.CalendarSeries.context;
                return event;
            });
 ...
 * @param  {Object}     callback.err    An error object, if any
 */
var subscribeSeries = module.exports.subscribeSeries = function(series, user, context, callback) {
    ...
    getOrCreateCalendar(user, function(err, calendar) {
        ...
        calendar.getSeries().complete(function(err, subscribedSeries) {
            ...
            calendar.addSeries(serieIdsToSubscribeTo, {'context': context}).complete(function(err) {
                if (err) {
