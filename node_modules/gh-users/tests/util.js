 ...
 * @throws {AssertionError}                                     Error thrown when an assertion failed
 */
var getUsers = module.exports.getUsers = function(client, app, query, limit, offset, callback) {
 ...
 * @throws {AssertionError}                                     Error thrown when an assertion failed
 */
var getUsersFails = module.exports.getUsersFails = function(client, app, query, limit, offset, code, callback) {
    client.user.getUsers(app, query, limit, offset, function(err, users) {
        assert.ok(err);
        assert.strictEqual(err.code, code);
        assert.ok(!users);
