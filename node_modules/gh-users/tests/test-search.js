...
describe('Users - Search', function() {
        ...
        TestsUtil.generateTestTenant(1, function(tenant, app) {
            _setup(app, function(jack, william, shirley) {
                ...
                TestsUtil.getGlobalAdminRestClient(function(globalAdminClient) {
                    UsersTestsUtil.getUsers(globalAdminClient, app.id, 'i', 2, 0, function(firstPage) {
                        assert.strictEqual(firstPage.results.length, 2);
                        var firstPageById = _.indexBy(firstPage.results, 'id');

                        // Get the third user
                        UsersTestsUtil.getUsers(globalAdminClient, app.id, 'i', 2, 2, function(secondPage) {
    ...
    it('verify validation when searching for users', function(callback) {
        // Invalid app id
        UsersTestsUtil.getUsersFails(global.tests.admins.cam2013.client, 'Not a number', null, null, null, 400, function() {
        ...
        _setup(global.tests.apps.cam2013, function(jack, william, shirley) {
            ...
            TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                UsersTestsUtil.getUsersFails(anonymousClient, null, null, null, null, 401, function() {
                    UsersTestsUtil.getUsersFails(anonymousClient, null, 'some query', null, null, 401, function() {
                        TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                            UsersTestsUtil.getUsersFails(anonymousGlobalAdminClient, null, null, null, null, 401, function() {
                                UsersTestsUtil.getUsersFails(anonymousGlobalAdminClient, null, 'some query', null, null, 401, function() {
                                    ...
                                    UsersTestsUtil.getUsersFails(jack.client, global.tests.apps.oxford2014.id, null, null, null, 401, function() {
                                        UsersTestsUtil.getUsersFails(jack.client, global.tests.apps.oxford2014.id, 'some query', null, null, 401, function() {

                                            // Regular users can search/page users from their own app
                                            UsersTestsUtil.getUsers(jack.client, null, null, null, null, function() {
                                                UsersTestsUtil.getUsers(jack.client, null, 'some query', null, null, function() {
                                                    ...
                                                    UsersTestsUtil.getUsersFails(global.tests.admins.cam2013.client, global.tests.apps.oxford2014.id, null, null, null, 401, function() {
                                                        UsersTestsUtil.getUsersFails(global.tests.admins.cam2013.client, global.tests.apps.oxford2014.id, 'some query', null, null, 401, function() {
                                                            ...
                                                            UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, null, null, null, null, function() {
                                                                UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, null, 'some query', null, null, function() {
                                                                    UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, global.tests.apps.cam2013.id, null, null, null, function() {
                                                                        UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, global.tests.apps.cam2013.id, 'some query', null, null, function() {
