...
describe('Users - Search', function() {
    ...
    var _setup = function(callback) {
        TestsUtil.generateTestUsers(global.tests.apps.cam2013, 3, false, function(jack, william, shirley) {

            // Update the display names and email addresses
            UsersTestsUtil.assertUpdateUser(jack.client, jack.profile.id, {'displayName': 'Jack Daniels', 'email': TestsUtil.generateTestEmailAddress('jd123')}, function() {
                UsersTestsUtil.assertUpdateUser(william.client, william.profile.id, {'displayName': 'William Lawson', 'email': TestsUtil.generateTestEmailAddress('wl4567')}, function() {
                    UsersTestsUtil.assertUpdateUser(shirley.client, shirley.profile.id, {'displayName': 'Shirley Temple', 'email': TestsUtil.generateTestEmailAddress('st789')}, function() {
    ...
    it('verify users can be queried on their display name', function(callback) {
        _setup(function(jack, william, shirley) {

            // Search for 'jac'
            UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, null, 'jac', 50, null, function(users) {
    ...
    it('verify users can be queried on their email address', function(callback) {
        _setup(function(jack, william, shirley) {
            ...
            UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, null, 'jd', 50, null, function(users) {
                assert.ok(users.results.length > 0);
    ...
    it('verify search results can be paged', function(callback) {
        _setup(function(jack, william, shirley) {
            ...
            UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, null, 'i', 2, 0, function(firstPage) {
                assert.strictEqual(firstPage.results.length, 2);
                var firstPageById = _.indexBy(firstPage.results, 'id');

                UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, null, 'i', 2, 2, function(secondPage) {
                    assert.strictEqual(secondPage.results.length, 2);

                    // Assert each user in the second page is not returned in the first page
                    _.each(secondPage.results, function(user) {
                        assert.ok(!firstPageById[user.id]);
                    });
    ...
    it('verify authorization when searching for users', function(callback) {
        _setup(function(jack, william, shirley) {
            ...
            TestsUtil.getAnonymousAppUserClient(global.tests.apps.cam2013, function(anonymousClient) {
                UsersTestsUtil.getUsersFails(anonymousClient, null, null, null, null, 401, function() {
                    UsersTestsUtil.getUsersFails(anonymousClient, null, 'some filter', null, null, 401, function() {
                        TestsUtil.getAnonymousGlobalAdminRestClient(function(anonymousGlobalAdminClient) {
                            UsersTestsUtil.getUsersFails(anonymousGlobalAdminClient, null, null, null, null, 401, function() {
                                UsersTestsUtil.getUsersFails(anonymousGlobalAdminClient, null, 'some filter', null, null, 401, function() {

                                    // Regular user can't search/page users from another application
                                    UsersTestsUtil.getUsersFails(jack.client, global.tests.apps.oxford2014.id, null, null, null, 401, function() {
                                        UsersTestsUtil.getUsersFails(jack.client, global.tests.apps.oxford2014.id, 'some filter', null, null, 401, function() {

                                            // Regular users can search/page users from their own app
                                            UsersTestsUtil.getUsers(jack.client, null, null, null, null, function() {
                                                UsersTestsUtil.getUsers(jack.client, null, 'some filter', null, null, function() {

                                                    // App admins can't search/page users from another app
                                                    UsersTestsUtil.getUsersFails(global.tests.admins.cam2013.client, global.tests.apps.oxford2014.id, null, null, null, 401, function() {
                                                        UsersTestsUtil.getUsersFails(global.tests.admins.cam2013.client, global.tests.apps.oxford2014.id, 'some filter', null, null, 401, function() {

                                                            // App admins can search/page users from their own app
                                                            UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, null, null, null, null, function() {
                                                                UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, null, 'some filter', null, null, function() {
                                                                    UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, global.tests.apps.cam2013.id, null, null, null, function() {
                                                                        UsersTestsUtil.getUsers(global.tests.admins.cam2013.client, global.tests.apps.cam2013.id, 'some filter', null, null, function() {
