        ...
        it('verify events order and metadata', function(callback) {
            TestsUtil.generateTestUsers(global.tests.apps.cam2013, 1, false, function(simon) {
                ...
                SeriesTestUtil.generateSerieWithEvents(simon.client, 3, 4, start, end, function(series) {
                    ...
                    SeriesTestUtil.assertSubscribeSeries(simon.client, series[0].id, simon.profile.id, function() {
                        SeriesTestUtil.assertSubscribeSeries(simon.client, series[1].id, simon.profile.id, function() {
                            SeriesTestUtil.assertSubscribeSeries(simon.client, series[2].id, simon.profile.id, function() {
