...
#
#   * The build was performed on the fronteerio/grasshopper repository
#   * The build was performed on the master branch
#   * The build was not performed on a pull request to the master branch
##

EXPECTED_REPOSITORY="fronteerio/grasshopper"
EXPECTED_BRANCH="master"
EXPECTED_PULL_REQUEST=false

function package_and_upload {
    rm -rf ./target
    ./bin/package -su --upload-bucket=fronteer-grasshopper --upload-region=eu-west-1
}
